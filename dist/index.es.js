...
var RegistrationForm = function (props) {
    ...
    return (jsx(Formik, __assign({ initialValues: initialFormValues, validationSchema: RegistrationValidationSchema, onSubmit: function (values) {
            register(values);
...
var DevelopmentHint = function (props) {
    var _a = __read(useState(props.visible), 2), visible = _a[0], setVisible = _a[1];
    /**
...
var ActiveStorageDropzone = function (props) {
    var _a = __read(useState(0), 2), uploadsInProgress = _a[0], setUploadsInProgress = _a[1];
    // standard upload icon for dropzone (from boostrap icons)
    var standardUploadIcon = (jsxs("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32", fill: "currentColor", className: "bi bi-cloud-arrow-up", viewBox: "0 0 16 16" }, { children: [jsx("path", { fillRule: "evenodd", d: "M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z" }), jsx("path", { d: "M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383zm.653.757c-.757.653-1.153 1.44-1.153 2.056v.448l-.445.049C2.064 6.805 1 7.952 1 9.318 1 10.785 2.23 12 3.781 12h8.906C13.98 12 15 10.988 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3a4.53 4.53 0 0 0-2.941 1.1z" })] })));
    /**
    ...
    return (jsxs("div", { children: [props.pasteZone && (jsx("input", { type: "text", className: "w-100 active-storage-dropzone-pastezone-container p-2", value: props.textPastezone || 'Copy and paste some files here', onPaste: onPaste, readOnly: true })), jsx(Dropzone$1, __assign({ onDropAccepted: onDropAccepted, multiple: props.multiple, maxFiles: props.maxFiles, maxSize: props.maxSize, onDropRejected: onDropzoneRejection, accept: props.accept }, { children: function (_a) {
                    var _b = _a === void 0 ? useDropzone() : _a, getRootProps = _b.getRootProps, getInputProps = _b.getInputProps;
                    return (jsx("section", { children: jsxs("div", __assign({}, getRootProps(), { className: "active-storage-dropzone-dropzone-container p-4 ".concat(props.className) }, { children: [jsx("input", __assign({}, getInputProps())), jsx("p", __assign({ className: 'm-0' }, { children: props.textDropzone || "Drag 'n' drop some files here, or click to select files" })), previews.length > 0 ? (jsx("aside", __assign({ className: 'card-deck justify-content-center w-100 m-4' }, { children: previews }))) : (jsx("div", __assign({ className: 'm-0' }, { children: props.customIcon || standardUploadIcon }))), progressSpinners.length > 0 && (jsx("aside", __assign({ className: 'card-deck justify-content-center w-100 m-4' }, { children: progressSpinners })))] })) }));
                } }))] }));
};
...
var ResetPasswordForm = function (props) {
     ...
     * @param values
     */
    var resetPassword = useCallback(function (values) { return __awaiter(void 0, void 0, void 0, function () {
        var e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
