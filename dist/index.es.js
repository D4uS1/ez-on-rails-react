...
import React__default, { createContext, forwardRef, createElement, useContext, useImperativeHandle, useEffect, Children, useRef, useReducer, useCallback, useMemo, useLayoutEffect, useState, Fragment as Fragment$2 } from 'react';
...
var rsAstralRange$4 = '\\ud800-\\udfff',
    rsComboMarksRange$5 = '\\u0300-\\u036f\\ufe20-\\ufe23',
    rsComboSymbolsRange$5 = '\\u20d0-\\u20f0',
    rsDingbatRange$2 = '\\u2700-\\u27bf',
...
var rsApos$3 = "['\u2019]",
    rsAstral$1 = '[' + rsAstralRange$4 + ']',
    rsBreak$2 = '[' + rsBreakRange$2 + ']',
    rsCombo$4 = '[' + rsComboMarksRange$5 + rsComboSymbolsRange$5 + ']',
    rsDigits$2 = '\\d+',
    rsDingbat$2 = '[' + rsDingbatRange$2 + ']',
    rsLower$2 = '[' + rsLowerRange$2 + ']',
    rsMisc$2 = '[^' + rsAstralRange$4 + rsBreakRange$2 + rsDigits$2 + rsDingbatRange$2 + rsLowerRange$2 + rsUpperRange$2 + ']',
    rsFitz$3 = '\\ud83c[\\udffb-\\udfff]',
...
var rsLowerMisc$1 = '(?:' + rsLower$2 + '|' + rsMisc$2 + ')',
    rsUpperMisc$1 = '(?:' + rsUpper$2 + '|' + rsMisc$2 + ')',
    rsOptLowerContr$1 = '(?:' + rsApos$3 + '(?:d|ll|m|re|s|t|ve))?',
    rsOptUpperContr$1 = '(?:' + rsApos$3 + '(?:D|LL|M|RE|S|T|VE))?',
    ...
    rsSymbol$1 = '(?:' + [rsNonAstral$3 + rsCombo$4 + '?', rsCombo$4, rsRegional$3, rsSurrPair$3, rsAstral$1].join('|') + ')';

/** Used to match apostrophes. */
var reApos$2 = RegExp(rsApos$3, 'g');

/**
 * Used to match [combining diacritical marks](https://en.wikipedia.org/wiki/Combining_Diacritical_Marks) and
 * [combining diacritical marks for symbols](https://en.wikipedia.org/wiki/Combining_Diacritical_Marks_for_Symbols).
 */
var reComboMark$2 = RegExp(rsCombo$4, 'g');
...
var reUnicodeWord$2 = RegExp([
  rsUpper$2 + '?' + rsLower$2 + '+' + rsOptLowerContr$1 + '(?=' + [rsBreak$2, rsUpper$2, '$'].join('|') + ')',
  rsUpperMisc$1 + '+' + rsOptUpperContr$1 + '(?=' + [rsBreak$2, rsUpper$2 + rsLowerMisc$1, '$'].join('|') + ')',
  rsUpper$2 + '?' + rsLowerMisc$1 + '+' + rsOptLowerContr$1,
  rsUpper$2 + '+' + rsOptUpperContr$1,
  rsDigits$2,
  rsEmoji$2
].join('|'), 'g');

/** Used to detect strings with [zero-width joiners or code points from the astral planes](http://eev.ee/blog/2015/09/12/dark-corners-of-unicode/). */
var reHasUnicode$1 = RegExp('[' + rsZWJ$4 + rsAstralRange$4  + rsComboMarksRange$5 + rsComboSymbolsRange$5 + rsVarRange$4 + ']');
...
/** Used to compose unicode character classes. */
var rsAstralRange$3 = '\\ud800-\\udfff',
    rsComboMarksRange$4 = '\\u0300-\\u036f\\ufe20-\\ufe23',
    rsComboSymbolsRange$4 = '\\u20d0-\\u20f0',
    rsDingbatRange$1 = '\\u2700-\\u27bf',
...
var rsApos$2 = "['\u2019]",
    ...
    rsCombo$3 = '[' + rsComboMarksRange$4 + rsComboSymbolsRange$4 + ']',
    rsDigits$1 = '\\d+',
...
var rsLowerMisc = '(?:' + rsLower$1 + '|' + rsMisc$1 + ')',
    rsUpperMisc = '(?:' + rsUpper$1 + '|' + rsMisc$1 + ')',
    rsOptLowerContr = '(?:' + rsApos$2 + '(?:d|ll|m|re|s|t|ve))?',
    rsOptUpperContr = '(?:' + rsApos$2 + '(?:D|LL|M|RE|S|T|VE))?',
...
var reUnicodeWord$1 = RegExp([
  rsUpper$1 + '?' + rsLower$1 + '+' + rsOptLowerContr + '(?=' + [rsBreak$1, rsUpper$1, '$'].join('|') + ')',
  rsUpperMisc + '+' + rsOptUpperContr + '(?=' + [rsBreak$1, rsUpper$1 + rsLowerMisc, '$'].join('|') + ')',
  rsUpper$1 + '?' + rsLowerMisc + '+' + rsOptLowerContr,
  rsUpper$1 + '+' + rsOptUpperContr,
  rsDigits$1,
  rsEmoji$1
].join('|'), 'g');
 ...
 * @param path
 */
var toBaseUrl = function (path) {
    if (path.startsWith('/')) {
        path = path.slice(1);
    }
    return "".concat(EzOnRailsConfig.baseUrl()).concat(path);
};
/**
 ...
 */
var EzOnRailsHttpError = /** @class */ (function (_super) {
    __extends(EzOnRailsHttpError, _super);
    /**
     ...
     */
    function EzOnRailsHttpError(message, httpStatusCode) {
 ...
 * @param authInfo
 */
var authInfoToHeader = function (authInfo) {
    if (!authInfo)
        return undefined;
    return {
        uid: authInfo.uid,
...
var EzOnRailsHttpClient = {
     ...
     * @param authInfo
     */
    defaultHttpHeader: function (authInfo) {
 ...
 */
var EzOnRailsSwr = {
    fetcher: function (url, method, data, authInfo) {
        ...
        return __awaiter$1(void 0, void 0, void 0, function () {
            return __generator$1(this, function (_a) {
                ...
                switch (method) {
                    case 'post': {
                        return [2 /*return*/, EzOnRailsHttpClient.post(url, data, authInfo)];
                    }
                    case 'put': {
                        return [2 /*return*/, EzOnRailsHttpClient.put(url, data, authInfo)];
                    }
                    case 'patch': {
                        return [2 /*return*/, EzOnRailsHttpClient.patch(url, data, authInfo)];
                    }
                    case 'delete': {
                        return [2 /*return*/, EzOnRailsHttpClient.delete(url, data, authInfo)];
                    }
                    default: {
                        return [2 /*return*/, EzOnRailsHttpClient.get(url, data, authInfo)];
                    }
                }
            });
        });
  ...
  function validate(_ref, cb) {
    let {
      ...
      sync
        ...
        rest = _objectWithoutPropertiesLoose$3(_ref, ["value", "path", "label", "options", "originalValue", "sync"]);
...
function useFormik(_ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    useEffect(function () {
      !(typeof isInitialValid === 'undefined') ? process.env.NODE_ENV !== "production" ? warning$1(false, 'isInitialValid has been deprecated and will be removed in future versions of Formik. Please use initialErrors or validateOnMount instead.') : warning$1(false) : void 0; // eslint-disable-next-line
    }, []);
  }
  ...
  var handleSubmit = useEventCallback(function (e) {
    ...
    if (process.env.NODE_ENV !== "production" && typeof document !== 'undefined') {
      ...
      if (activeElement !== null && activeElement instanceof HTMLButtonElement) {
        !(activeElement.attributes && activeElement.attributes.getNamedItem('type')) ? process.env.NODE_ENV !== "production" ? warning$1(false, 'You submitted a Formik form using a button with an unspecified `type` attribute.  Most browsers default button elements to `type="submit"`. If this is not a submit button, please add `type="button"`.') : warning$1(false) : void 0;
      }
    }
...
function Formik(props) {
  ...
  if (process.env.NODE_ENV !== "production") {
    // eslint-disable-next-line react-hooks/rules-of-hooks
    useEffect(function () {
      !!props.render ? process.env.NODE_ENV !== "production" ? warning$1(false, "<Formik render> has been deprecated and will be removed in future versions of Formik. Please use a child callback function instead. To get rid of this warning, replace <Formik render={(props) => ...} /> with <Formik>{(props) => ...}</Formik>") : warning$1(false) : void 0; // eslint-disable-next-line
    }, []);
  }
...
var Form$2 = /*#__PURE__*/forwardRef(function (props, ref) {
...
var RegistrationForm = function (props) {
    var _a = __read$1(useState(false), 2), inProgress = _a[0], setInProgress = _a[1];
    /**
    ...
    var register = function (values) { return __awaiter$1(void 0, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, EzOnRailsHttpClient.signUp(values)];
                case 2:
                    _a.sent();
    ...
    return jsx("div", __assign({ className: "ez-on-rails-form-outer-container" }, { children: jsx(Formik, __assign({ initialValues: initialFormValues, validationSchema: RegistrationValidationSchema, onSubmit: function (values) {
                register(values);
            } }, { children: function (_a) {
                var errors = _a.errors, handleChange = _a.handleChange, handleSubmit = _a.handleSubmit;
                return (jsxs("form", __assign({ onSubmit: handleSubmit, className: props.containerClassName || 'ez-on-rails-form-container' }, { children: [jsxs(Form$1.Group, __assign({ id: 'username-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelUsername || 'Benutzername' }), void 0), jsx(Form$1.Control, { id: 'username', className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "text", onChange: handleChange, isInvalid: !!errors.username }, void 0), jsx(Form$1.Control.Feedback, __assign({ className: props.fieldErrorClassName || 'ez-on-rails-form-field-error', type: "invalid" }, { children: errors.username }), void 0)] }), void 0), jsxs(Form$1.Group, __assign({ id: 'email-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelEmail || 'E-Mail Adresse' }), void 0), jsx(Form$1.Control, { id: 'email', className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "email", onChange: handleChange, isInvalid: !!errors.email }, void 0), jsx(Form$1.Control.Feedback, __assign({ className: props.fieldErrorClassName || 'ez-on-rails-form-field-error', type: "invalid" }, { children: errors.email }), void 0)] }), void 0), jsxs(Form$1.Group, __assign({ id: 'password-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelPassword || 'Passwort' }), void 0), jsx(Form$1.Control, { id: 'password', className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "password", onChange: handleChange, isInvalid: !!errors.password }, void 0), jsx(Form$1.Control.Feedback, __assign({ className: props.fieldErrorClassName || 'ez-on-rails-form-field-error', type: "invalid" }, { children: errors.password }), void 0)] }), void 0), jsxs(Form$1.Group, __assign({ id: 'password-confirmation-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelPasswordConfirmation || 'Passwort wiederholen' }), void 0), jsx(Form$1.Control, { id: 'passwordConfirmation', className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "password", onChange: handleChange, isInvalid: !!errors.passwordConfirmation }, void 0), jsx(Form$1.Control.Feedback, __assign({ className: props.fieldErrorClassName || 'ez-on-rails-form-field-error', type: "invalid" }, { children: errors.passwordConfirmation }), void 0)] }), void 0), jsx(Form$1.Group, __assign({ id: 'privacy-policy-accepted-container', className: props.fieldCheckboxContainerClassName || 'ez-on-rails-form-field-container' }, { children: jsx(Form$1.Check, { id: 'privacyPolicyAccepted', className: props.fieldCheckboxInputClassName || 'ez-on-rails-form-field', type: "checkbox", label: props.labelPrivacyPolicyAccepted ||
                                    jsxs("span", { children: ["Ich habe die ", jsx("a", __assign({ href: props.privacyPolicyUrl, target: "_blank", rel: "noopener noreferrer" }, { children: "Datenschutzerkl\u00E4rung" }), void 0), " und ", jsx("a", __assign({ href: props.generalTermsUrl, target: "_blank", rel: "noopener noreferrer" }, { children: "allgemeinen Gesch\u00E4ftsbedingungen" }), void 0), " gelesen und akzeptiere diese."] }, void 0), onChange: handleChange, isInvalid: !!errors.privacyPolicyAccepted, feedbackType: 'invalid', feedback: errors.privacyPolicyAccepted }, void 0) }), void 0), !inProgress && (jsx("div", __assign({ className: props.submitButtonContainerClassName || 'ez-on-rails-form-submit-container' }, { children: jsx(Button, __assign({ className: props.submitButtonClassName || 'ez-on-rails-form-submit-button', type: "submit", variant: "primary" }, { children: props.labelSubmitButton || "Registrieren" }), void 0) }), void 0))] }), void 0));
            } }), void 0) }), void 0);
};
...
var LoginForm = function (props) {
    ...
    return jsx("div", __assign({ className: "ez-on-rails-form-outer-container" }, { children: jsx(Formik, __assign({ initialValues: initialFormValues, onSubmit: function (values) {
                login(values);
            }, validationSchema: LoginValidationSchema }, { children: function (_a) {
                var errors = _a.errors, handleChange = _a.handleChange, handleSubmit = _a.handleSubmit;
                return (jsxs("form", __assign({ onSubmit: handleSubmit, className: props.containerClassName || 'ez-on-rails-form-container' }, { children: [jsxs(Form$1.Group, __assign({ id: 'email-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelEmail || 'E-Mail Adresse' }), void 0), jsx(Form$1.Control, { id: 'email', type: "email", onChange: handleChange, className: props.fieldInputClassName || 'ez-on-rails-form-field', isInvalid: !!errors.email }, void 0), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.email }), void 0)] }), void 0), jsxs(Form$1.Group, __assign({ id: 'password-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelPassword || 'Passwort' }), void 0), jsx(Form$1.Control, { id: 'password', type: "password", onChange: handleChange, className: props.fieldInputClassName || 'ez-on-rails-form-field', isInvalid: !!errors.password }, void 0), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.password }), void 0)] }), void 0), !props.hideStayLoggedIn &&
                            jsx(Form$1.Group, __assign({ id: 'stay-logged-in-container', className: props.fieldCheckboxContainerClassName || 'ez-on-rails-form-field-container' }, { children: jsx(Form$1.Check, { id: 'stayLoggedIn', className: props.fieldCheckboxInputClassName || 'ez-on-rails-form-field', type: "checkbox", label: props.labelStayLoggedIn || "Auf diesem Gerät eingeloggt bleiben", onChange: handleChange }, void 0) }), void 0), !inProgress && (jsx("div", __assign({ className: props.submitButtonContainerClassName || 'ez-on-rails-form-submit-container' }, { children: jsx(Button, __assign({ variant: "primary", type: "submit", className: props.submitButtonClassName || 'ez-on-rails-form-submit-button' }, { children: props.labelSubmitButton || "Login" }), void 0) }), void 0))] }), void 0));
            } }), void 0) }), void 0);
};
...
var LostPasswordForm = function (props) {
    ...
    return jsx("div", __assign({ className: "ez-on-rails-form-outer-container" }, { children: jsx(Formik, __assign({ initialValues: initialFormValues, onSubmit: function (values) {
                ...
                var errors = _a.errors, handleChange = _a.handleChange, handleSubmit = _a.handleSubmit;
                return (jsxs("form", __assign({ onSubmit: handleSubmit, className: props.containerClassName || 'ez-on-rails-form-container' }, { children: [jsxs(Form$1.Group, __assign({ id: 'email-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelEmail || 'E-Mail Adresse' }), void 0), jsx(Form$1.Control, { id: 'email', type: "email", onChange: handleChange, className: props.fieldInputClassName || 'ez-on-rails-form-field', isInvalid: !!errors.email }, void 0), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.email }), void 0)] }), void 0), !inProgress && (jsx("div", __assign({ className: props.submitButtonContainerClassName || 'ez-on-rails-form-submit-container' }, { children: jsx(Button, __assign({ variant: "primary", type: "submit", className: props.submitButtonClassName || 'ez-on-rails-form-submit-button' }, { children: props.labelSubmitButton || "Passwort zurücksetzen" }), void 0) }), void 0))] }), void 0));
            } }), void 0) }), void 0);
};
...
var DevelopmentHint = function (props) {
    var _a = __read$1(useState(props.visible), 2), visible = _a[0], setVisible = _a[1];
    /**
     ...
     */
    var onClickContainer = function () {
        setVisible(false);
        setTimeout(dismissTimeout, props.dismissTimeout || 20000);
    };
    return visible ? jsx("div", __assign({ onClick: onClickContainer, className: 'development-hint-container' }, { children: jsx("span", __assign({ className: 'development-hint-text' }, { children: "development" }), void 0) }), void 0) : null;
};
...
var css_248z = ".active-storage-dropzone-dropzone-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  border-width: 2px;\n  border-radius: 2px;\n  border-color: #eeeeee;\n  border-style: dashed;\n  background-color: #fafafa;\n  color: #bdbdbd;\n  width: 100%;\n}\n\n.active-storage-dropzone-dropzone-container img {\n  max-width: 100%;\n  max-height: 100%;\n}\n\n.active-storage-dropzone-pastezone-container {\n  text-align: center;\n  border-width: 2px;\n  border-radius: 2px;\n  border-color: #eeeeee;\n  border-style: solid;\n  border-bottom: none;\n  background-color: #fafafa;\n  color: #bdbdbd;\n  width: 100%;\n}\n";
 ...
 * @param filename
 */
var blobShowPath = function (signedId, filename) {
    return "rails/active_storage/blobs/".concat(signedId, "/").concat(filename);
};
/**
...
var ActiveStorageDropzone = function (props) {
    var _a = __read$1(useState(0), 2), uploadsInProgress = _a[0], setUploadsInProgress = _a[1];
    // standard upload icon for dropzone (from boostrap icons)
    var standardUploadIcon = (jsxs("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32", fill: "currentColor", className: "bi bi-cloud-arrow-up", viewBox: "0 0 16 16" }, { children: [jsx("path", { fillRule: "evenodd", d: "M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z" }, void 0), jsx("path", { d: "M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383zm.653.757c-.757.653-1.153 1.44-1.153 2.056v.448l-.445.049C2.064 6.805 1 7.952 1 9.318 1 10.785 2.23 12 3.781 12h8.906C13.98 12 15 10.988 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3a4.53 4.53 0 0 0-2.941 1.1z" }, void 0)] }), void 0));
    /**
    ...
    var removeFile = function (event, signedId) { return __awaiter$1(void 0, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, removeFileFromServer(signedId)];
                case 1:
                    // remove file from server to prevent garbage
                    _a.sent();
     ...
     * @param event
     */
    var onDirectUploadProgress = function (event) {
    ...
    var onDropAccepted = function (acceptedFiles) {
        ...
        if (props.maxFiles) {
            var maxNewFiles = props.maxFiles - (props.files.length + uploadsInProgress);
        ...
        if (props.maxSize) {
            var sizeFilteredFiles = acceptedFiles.filter(function (file) { return file.size <= props.maxSize; });
        ...
        setUploadsInProgress(function (uploadsInProgress) { return uploadsInProgress + acceptedFiles.length; });
        ...
        acceptedFiles.forEach(function (acceptedFile) {
            ...
            upload.create(function (error, blob) {
                setUploadsInProgress(function (uploadsInProgress) { return uploadsInProgress - 1; });
                // if some error occurs, just print it to the console and do nothing else
                if (error) ;
                else {
                    var file = { signedId: blob.signed_id };
    ...
    var previews = props.files.map(function (file) { return (jsxs("div", __assign({ className: "card w-25 animate__animated animate__fadeIn mb-4", style: { flex: '0 0 auto' } }, { children: [jsx("div", __assign({ className: 'card-header p-1' }, { children: jsx("button", __assign({ onClick: function (event) { return removeFile(event, file.signedId || ''); }, type: "button", className: "close", "aria-label": "Close" }, { children: jsx("span", __assign({ "aria-hidden": "true" }, { children: "\u00D7" }), void 0) }), void 0) }), void 0), jsx("div", __assign({ className: 'd-flex justify-content-center align-items-center w-100 h-100' }, { children: jsx("img", { src: toBaseUrl(file.path || ''), alt: file.filename, className: 'd-block mw-100 m-auto m-0 rounded p-1' }, void 0) }), void 0)] }), file.signedId)); });
    // shows some indicator for some incoming files
    var progressSpinners = [];
    for (var i = 0; i < uploadsInProgress; i++) {
        progressSpinners.push(jsx("div", __assign({ className: "card w-25 mb-4", style: { flex: '0 0 auto' } }, { children: jsx("div", __assign({ className: 'd-flex justify-content-center align-items-center w-100 h-100' }, { children: jsx("div", __assign({ className: "p-4 text-center" }, { children: jsx("div", __assign({ className: "spinner-border", role: "status" }, { children: jsx("span", __assign({ className: "sr-only" }, { children: "Loading..." }), void 0) }), void 0) }), void 0) }), void 0) }), i));
    }
    /**
     ...
     */
    var onDropzoneRejection = function (fileRejections) {
        // too many files ?
        if (fileRejections.some(function (fileRejection) { return fileRejection.errors[0].code === ErrorCode.TooManyFiles; })) {
            props.onMaxFilesError(props.maxFiles);
        }
        // invalid type ?
        if (fileRejections.some(function (fileRejection) { return fileRejection.errors[0].code === ErrorCode.FileInvalidType; })) {
            props.onInvalidTypeError(props.accept);
        }
        // file too large ?
        if (fileRejections.some(function (fileRejection) { return fileRejection.errors[0].code === ErrorCode.FileTooLarge; })) {
            props.onMaxSizeError(props.maxSize);
        }
    };
    // dropzone having a drop area
    return (jsxs("div", { children: [props.pasteZone && (jsx("input", { type: "text", className: "w-100 active-storage-dropzone-pastezone-container p-2", value: props.textPastezone || 'Copy and paste some files here', onPaste: onPaste, readOnly: true }, void 0)), jsx(Dropzone$1, __assign({ onDropAccepted: onDropAccepted, multiple: props.multiple, maxFiles: props.maxFiles, maxSize: props.maxSize, onDropRejected: onDropzoneRejection, accept: props.accept }, { children: function (_a) {
                    var _b = _a === void 0 ? useDropzone() : _a, getRootProps = _b.getRootProps, getInputProps = _b.getInputProps;
                    return (jsx("section", { children: jsxs("div", __assign({}, getRootProps(), { className: "active-storage-dropzone-dropzone-container p-4 ".concat(props.className) }, { children: [jsx("input", __assign({}, getInputProps()), void 0), jsx("p", __assign({ className: 'm-0' }, { children: props.textDropzone || "Drag 'n' drop some files here, or click to select files" }), void 0), previews.length > 0 ? (jsx("aside", __assign({ className: 'card-deck justify-content-center w-100 m-4' }, { children: previews }), void 0)) : (jsx("div", __assign({ className: 'm-0' }, { children: props.customIcon || standardUploadIcon }), void 0)), progressSpinners.length > 0 && (jsx("aside", __assign({ className: 'card-deck justify-content-center w-100 m-4' }, { children: progressSpinners }), void 0))] }), void 0) }, void 0));
                } }), void 0)] }, void 0));
};
...
var ResetPasswordForm = function (props) {
     ...
     * @param values
     */
    var resetPassword = useCallback(function (values) { return __awaiter$1(void 0, void 0, void 0, function () {
        var e_1;
        return __generator$1(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, EzOnRailsHttpClient.passwordReset(__assign(__assign({}, values), { resetPasswordToken: props.resetPasswordToken }))];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, props.onResetPasswordSuccess()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    e_1 = _a.sent();
                    props.onResetPasswordError(e_1);
                    setInProgress(false);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
    ...
    return jsx("div", __assign({ className: "ez-on-rails-form-outer-container" }, { children: jsx(Formik, __assign({ initialValues: initialFormValues, onSubmit: function (values) {
                ...
                var errors = _a.errors, handleChange = _a.handleChange, handleSubmit = _a.handleSubmit;
                return (jsxs("form", __assign({ onSubmit: handleSubmit, className: props.containerClassName || 'ez-on-rails-form-container' }, { children: [jsxs(Form$1.Group, __assign({ id: 'password-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelPassword || 'Passwort' }), void 0), jsx(Form$1.Control, { id: 'password', type: "password", onChange: handleChange, className: props.fieldInputClassName || 'ez-on-rails-form-field', isInvalid: !!errors.password }, void 0), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.password }), void 0)] }), void 0), jsxs(Form$1.Group, __assign({ id: 'password-confirmation-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelPasswordConfirmation || 'Passwort' }), void 0), jsx(Form$1.Control, { id: 'passwordConfirmation', type: "password", onChange: handleChange, className: props.fieldInputClassName || 'ez-on-rails-form-field', isInvalid: !!errors.passwordConfirmation }, void 0), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.passwordConfirmation }), void 0)] }), void 0), !inProgress && (jsx("div", __assign({ className: props.submitButtonContainerClassName || 'ez-on-rails-form-submit-container' }, { children: jsx(Button, __assign({ variant: "primary", type: "submit", className: props.submitButtonClassName || 'ez-on-rails-form-submit-button' }, { children: props.labelSubmitButton || "Passwort ändern" }), void 0) }), void 0))] }), void 0));
            } }), void 0) }), void 0);
};
...
var ProtectedPage = function (props) {
    return (jsx("div", { children: props.authInfo ?
            props.children
            :
                jsx("div", __assign({ className: props.accessDeniedClassName || 'ez-on-rails-protected-page-access-denied-container' }, { children: props.accessDeniedText || 'Sie müssen eingeloggt sein um diesen Inhalt sehen zu können.' }), void 0) }, void 0));
};
...
var UpdateUserForm = function (props) {
    var _a = __read$1(useState(false), 2), inProgress = _a[0], setInProgress = _a[1];
    var _b = __read$1(useState(null), 2), initialFormData = _b[0], setInitialFormData = _b[1];
    /**
    ...
    return (jsx("div", __assign({ className: "ez-on-rails-form-outer-container" }, { children: initialFormData ? (jsx(Formik, __assign({ initialValues: initialFormData, validationSchema: UpdateUserValidationSchema, enableReinitialize: true, onSubmit: function (values) {
                ...
                return (jsxs("form", __assign({ onSubmit: handleSubmit, className: props.containerClassName || 'ez-on-rails-form-container' }, { children: [jsxs(Form$1.Group, __assign({ id: 'username-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelUsername || 'Benutzername' }), void 0), jsx(Form$1.Control, { id: 'username', className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "text", value: values.username, onChange: handleChange, isInvalid: !!errors.username }, void 0), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.username }), void 0)] }), void 0), jsxs(Form$1.Group, __assign({ id: 'email-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelEmail || 'E-Mail Adresse' }), void 0), jsx(Form$1.Control, { id: 'email', className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "email", value: values.email, onChange: handleChange, isInvalid: !!errors.email }, void 0), values.unconfirmedEmail && (jsxs("div", __assign({ className: props.fieldInfoClassName || 'ez-on-rails-unconfirmed-email-text' }, { children: [props.unconfirmedEmailText || 'Die folgende E-Mail Adresse wurde noch nicht bestätigt: ', " ", values.unconfirmedEmail] }), void 0)), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.email }), void 0)] }), void 0), jsxs(Form$1.Group, __assign({ id: 'password-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelPassword || 'Passwort' }), void 0), jsx(Form$1.Control, { id: 'password', className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "password", value: values.password, onChange: handleChange, isInvalid: !!errors.password }, void 0), jsx("div", __assign({ className: props.fieldInfoClassName || 'ez-on-rails-password-optional-text' }, { children: props.passwordChangeOptionalText || 'Dieses Feld nur ausfüllen, wenn eine Passwort Änderung gewünscht ist.' }), void 0), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.password }), void 0)] }), void 0), jsxs(Form$1.Group, __assign({ id: 'password-confirmation-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelPasswordConfirmation || 'Passwort wiederholen' }), void 0), jsx(Form$1.Control, { id: 'passwordConfirmation', className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "password", value: values.passwordConfirmation, onChange: handleChange, isInvalid: !!errors.passwordConfirmation }, void 0), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.passwordConfirmation }), void 0)] }), void 0), jsxs(Form$1.Group, __assign({ id: 'avatar-container', className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelAvatar || 'Avatar' }), void 0), jsx("div", __assign({ className: props.dropzoneContainerClassName || 'ez-on-rails-form-field' }, { children: jsx(ActiveStorageDropzone, { authInfo: props.authInfo, onChange: function (blobs) { return setFieldValue('avatar', blobs.length > 0 ? blobs[0] : null); }, files: values.avatar ? [values.avatar] : [], multiple: false, maxFiles: 1, onMaxFilesError: function () { return setFieldError('avatar', props.avatarToManyFilesErrorText || 'Es ist nur eine Datei erlaubt.'); }, maxSize: props.avatarMaxSize || 5242880, onMaxSizeError: function () { return setFieldError('avatar', props.avatarToLargeErrorText || 'Es sind maximal 5MB große Bilder erlaubt.'); }, onInvalidTypeError: function () { return setFieldError('avatar', props.avatarWrongFormatErrorText || 'Ungültiges Dateiformat.'); } }, void 0) }), void 0), jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.avatar }), void 0)] }), void 0), !inProgress && (jsx("div", __assign({ className: props.submitButtonContainerClassName || 'ez-on-rails-form-submit-container' }, { children: jsx(Button, __assign({ type: "submit", variant: "primary", className: props.submitButtonClassName || 'ez-on-rails-form-submit-button' }, { children: props.labelSubmitButton || "Speichern" }), void 0) }), void 0))] }), void 0));
            } }), void 0)) :
            (jsx("div", { children: "Loading..." }, void 0)) }), void 0));
};

var EzOnRailsComponents = {
    ActiveStorageDropzone: ActiveStorageDropzone,
    DevelopmentHint: DevelopmentHint,
    LoginForm: LoginForm,
