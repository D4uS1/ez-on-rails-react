...
var Form$2 = /*#__PURE__*/React.forwardRef(function (props, ref) {
...
const Switch = /*#__PURE__*/React__namespace.forwardRef((props, ref) => /*#__PURE__*/jsxRuntime.jsx(FormCheck$1, {
  ...props,
  ref: ref,
  type: "switch"
}));
...
var LostPasswordForm = function (props) {
    ...
    return (jsxRuntime.jsx(Formik, __assign({ initialValues: initialFormValues, onSubmit: function (values) {
            ...
            var errors = _a.errors, handleChange = _a.handleChange, handleSubmit = _a.handleSubmit;
            return (jsxRuntime.jsxs("form", __assign({ onSubmit: handleSubmit, className: props.containerClassName || 'ez-on-rails-form-container' }, { children: [jsxRuntime.jsxs(Form$1.Group, __assign({ id: "email-container", className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsxRuntime.jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelEmail || 'E-Mail Adresse' })), jsxRuntime.jsx(Form$1.Control, { id: "email", type: "email", onChange: handleChange, className: props.fieldInputClassName || 'ez-on-rails-form-field', isInvalid: !!errors.email }), jsxRuntime.jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.email }))] })), !inProgress && (jsxRuntime.jsx("div", __assign({ className: props.submitButtonContainerClassName || 'ez-on-rails-form-submit-container' }, { children: jsxRuntime.jsx(Button$1, __assign({ variant: "primary", type: "submit", className: props.submitButtonClassName || 'ez-on-rails-form-submit-button' }, { children: props.labelSubmitButton || 'Passwort zurücksetzen' })) })))] })));
        } })));
};
...
var ActiveStorageDropzone = function (props) {
    ...
    var previews = props.files.map(function (file) { return (jsxRuntime.jsxs("div", __assign({ className: "card w-25 animate__animated animate__fadeIn mb-4", style: { flex: '0 0 auto' } }, { children: [jsxRuntime.jsx("div", __assign({ className: 'card-header p-1' }, { children: jsxRuntime.jsx("button", __assign({ onClick: function (event) { return removeFile(event, file.signedId || ''); }, type: "button", className: "close", "aria-label": "Close" }, { children: jsxRuntime.jsx("span", __assign({ "aria-hidden": "true" }, { children: "\u00D7" })) })) })), jsxRuntime.jsx("div", __assign({ className: 'd-flex justify-content-center align-items-center w-100 h-100' }, { children: jsxRuntime.jsx("img", { src: EzOnRailsHttpUtils.toBaseUrl(file.path || ''), alt: file.filename, className: 'd-block mw-100 m-auto m-0 rounded p-1' }) }))] }), file.signedId)); });
...
var ProtectedPage = function (props) {
    return (jsxRuntime.jsx("div", { children: props.authInfo ? (props.children) : (jsxRuntime.jsx("div", __assign({ className: props.accessDeniedClassName || 'ez-on-rails-protected-page-access-denied-container' }, { children: props.accessDeniedText || 'Sie müssen eingeloggt sein um diesen Inhalt sehen zu können.' }))) }));
};
...
var UpdateUserForm = function (props) {
    ...
    var _c = __read(React.useState(undefined), 2), unconfirmedEmail = _c[0], setUnconfirmedEmail = _c[1];
    /**
    ...
    var UpdateUserValidationSchema = create()
        ...
        .defined();
    return (jsxRuntime.jsx("div", __assign({ className: "ez-on-rails-form-outer-container" }, { children: initialFormData ? (jsxRuntime.jsx(Formik, __assign({ initialValues: initialFormData, validationSchema: UpdateUserValidationSchema, enableReinitialize: true, onSubmit: function (values) {
                updateUser(values);
            } }, { children: function (_a) {
                ...
                return (jsxRuntime.jsxs("form", __assign({ onSubmit: handleSubmit, className: props.containerClassName || 'ez-on-rails-form-container' }, { children: [!props.hideUsername && (jsxRuntime.jsxs(Form$1.Group, __assign({ id: "username-container", className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsxRuntime.jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelUsername || 'Benutzername' })), jsxRuntime.jsx(Form$1.Control, { id: "username", className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "text", value: values.username, onChange: handleChange, isInvalid: !!errors.username }), jsxRuntime.jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.username }))] }))), !props.hideEmail && (jsxRuntime.jsxs(Form$1.Group, __assign({ id: "email-container", className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsxRuntime.jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelEmail || 'E-Mail Adresse' })), jsxRuntime.jsx(Form$1.Control, { id: "email", className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "email", value: values.email, onChange: handleChange, isInvalid: !!errors.email }), unconfirmedEmail && (jsxRuntime.jsxs("div", __assign({ className: props.fieldInfoClassName || 'ez-on-rails-unconfirmed-email-text' }, { children: [props.unconfirmedEmailText ||
                                            'Die folgende E-Mail Adresse wurde noch nicht bestätigt: ', ' ', unconfirmedEmail] }))), jsxRuntime.jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.email }))] }))), !props.hidePassword && (jsxRuntime.jsxs(Form$1.Group, __assign({ id: "password-container", className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsxRuntime.jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelPassword || 'Passwort' })), jsxRuntime.jsx(Form$1.Control, { id: "password", className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "password", value: values.password, onChange: handleChange, isInvalid: !!errors.password }), jsxRuntime.jsx("div", __assign({ className: props.fieldInfoClassName || 'ez-on-rails-password-optional-text' }, { children: props.passwordChangeOptionalText ||
                                        'Dieses Feld nur ausfüllen, wenn eine Passwort Änderung gewünscht ist.' })), jsxRuntime.jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.password }))] }))), !props.hidePassword && (jsxRuntime.jsxs(Form$1.Group, __assign({ id: "password-confirmation-container", className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsxRuntime.jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelPasswordConfirmation || 'Passwort wiederholen' })), jsxRuntime.jsx(Form$1.Control, { id: "passwordConfirmation", className: props.fieldInputClassName || 'ez-on-rails-form-field', type: "password", value: values.passwordConfirmation, onChange: handleChange, isInvalid: !!errors.passwordConfirmation }), jsxRuntime.jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.passwordConfirmation }))] }))), !props.hideAvatar && (jsxRuntime.jsxs(Form$1.Group, __assign({ id: "avatar-container", className: props.fieldContainerClassName || 'ez-on-rails-form-field-container' }, { children: [jsxRuntime.jsx(Form$1.Label, __assign({ className: props.fieldLabelClassName || 'ez-on-rails-form-field-label' }, { children: props.labelAvatar || 'Avatar' })), jsxRuntime.jsx("div", __assign({ className: props.dropzoneContainerClassName || 'ez-on-rails-form-field' }, { children: jsxRuntime.jsx(ActiveStorageDropzone, { authInfo: props.authInfo, onChange: function (blobs) {
                                        ...
                                        } }) })), jsxRuntime.jsx(Form$1.Control.Feedback, __assign({ type: "invalid", className: props.fieldErrorClassName || 'ez-on-rails-form-field-error' }, { children: errors.avatar }))] }))), !inProgress && (jsxRuntime.jsx("div", __assign({ className: props.submitButtonContainerClassName || 'ez-on-rails-form-submit-container' }, { children: jsxRuntime.jsx(Button$1, __assign({ ref: props.submitRef, type: "submit", variant: "primary", className: props.submitButtonClassName || 'ez-on-rails-form-submit-button' }, { children: props.labelSubmitButton || 'Speichern' })) })))] })));
...
exports.ActiveStorageDropzone = ActiveStorageDropzone;
exports.DevelopmentHint = DevelopmentHint;
exports.EzOnRails = EzOnRails;
exports.EzOnRailsComponents = EzOnRailsComponents;
exports.EzOnRailsConfig = EzOnRailsConfig;
exports.EzOnRailsHttp = EzOnRailsHttp;
exports.EzOnRailsHttpError = EzOnRailsHttpError;
exports.LoginForm = LoginForm;
exports.LostPasswordForm = LostPasswordForm;
exports.ProtectedPage = ProtectedPage;
exports.RegistrationForm = RegistrationForm;
exports.ResendConfirmationForm = ResendConfirmationForm;
exports.ResetPasswordForm = ResetPasswordForm;
exports.UpdateUserForm = UpdateUserForm;
exports.defaultHttpHeader = defaultHttpHeader;
