"use strict";var ot=Object.create;var ne=Object.defineProperty;var lt=Object.getOwnPropertyDescriptor;var mt=Object.getOwnPropertyNames;var dt=Object.getPrototypeOf,ct=Object.prototype.hasOwnProperty;var ut=(e,t)=>{for(var r in t)ne(e,r,{get:t[r],enumerable:!0})},xe=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of mt(t))!ct.call(e,a)&&a!==r&&ne(e,a,{get:()=>t[a],enumerable:!(n=lt(t,a))||n.enumerable});return e};var h=(e,t,r)=>(r=e!=null?ot(dt(e)):{},xe(t||!e||!e.__esModule?ne(r,"default",{value:e,enumerable:!0}):r,e)),ft=e=>xe(ne({},"__esModule",{value:!0}),e);var St={};ut(St,{ActiveStorageDropzone:()=>ce,DevelopmentHint:()=>$e,EzOnRails:()=>Te,EzOnRailsHttp:()=>Ot,EzOnRailsHttpError:()=>K,EzOnRailsIntegrations:()=>It,LoginForm:()=>Le,LostPasswordForm:()=>Me,ProtectedPage:()=>Qe,RegistrationForm:()=>Oe,ResendConfirmationForm:()=>De,ResetPasswordForm:()=>Ke,UpdateUserForm:()=>rt,useEzApi:()=>Fe,useEzApiHttpClient:()=>le,useEzOnRails:()=>P,useEzScaff:()=>ze});module.exports=ft(St);var j=h(require("react"));var Pe=require("react"),ae=(0,Pe.createContext)({apiVersion:"1.0",backendUrl:"http://localhost:3000",authInfo:null,setBackendUrl:e=>{},setAuthInfo:e=>{},setApiVersion:e=>{}});var Te=e=>{let[t,r]=(0,j.useState)(e.backendUrl),[n,a]=(0,j.useState)(e.authInfo||null),[s,l]=(0,j.useState)(e.apiVersion),u=(0,j.useMemo)(()=>{let i={backendUrl:t,authInfo:n||null,apiVersion:s,setBackendUrl:r,setAuthInfo:a,setApiVersion:l};return i.backendUrl.endsWith("/")&&(i.backendUrl=i.backendUrl.slice(0,-1)),i},[t,n,s]);return j.default.createElement(ae.Provider,{value:u},e.children)};var E=h(require("react")),B=h(require("yup")),Ne=require("formik");var Y=require("react");var ve=require("react");var oe=require("convert-keys"),fe=e=>e.startsWith("/")?e.slice(1):e,pe=e=>e.endsWith("/")?e.slice(0,-1):e,pt=(e,t)=>`${pe(e)}/${fe(t)}`,gt=(e,t)=>`${pe(e)}/api/${fe(t)}`,bt=e=>e.replace(/[A-Z]/g,(t,r)=>r===0?t.toLowerCase():"_"+t.toLowerCase()),_e=e=>e&&(0,oe.toSnake)(e),we=e=>e&&(0,oe.toCamel)(e),Et=e=>Object.keys(e).map(t=>t+"="+e[t]).join("&"),ie=e=>typeof e=="string"&&/^\d{4}-\d{2}-\d{2}/.test(e)?new Date(e):Array.isArray(e)?e.map(t=>ie(t)):(typeof e=="object"&&Object.keys(e).forEach(t=>{e[t]=ie(e[t])}),e),se=e=>e instanceof Date?e.toISOString():Array.isArray(e)?e.map(t=>se(t)):(typeof e=="object"&&Object.keys(e).forEach(t=>{e[t]=se(e[t])}),e),ht=e=>se(_e(e)),Ct=e=>!e||typeof e!="object"?e:ie(we(e)),o={cleanupUrl:pe,cleanupPath:fe,toBaseUrl:pt,toApiUrl:gt,toSnakeCase:_e,toSnakeCaseString:bt,toCamelCase:we,toGetParameters:Et,toDates:ie,toDateStrings:se,toBackendParams:ht,toFrontendParams:Ct};var K=class extends Error{httpStatusCode;constructor(t,r){super(),this.message=t,this.httpStatusCode=r}};var xt=e=>{if(e)return{uid:e.uid,client:e.client,expiry:e.expiry,"token-type":e.tokenType,"access-token":e.accessToken}},Pt=e=>({uid:e.uid,client:e.client,expiry:e.expiry,tokenType:e["token-type"],accessToken:e["access-token"]}),S=(e,t)=>({"Content-Type":"application/json",Accept:"application/json","api-version":t,...xt(e)}),L=async(e,t,r,n)=>{let a=await fetch(t,{method:e,headers:n,body:r?JSON.stringify(r):null});if(a.status>=400)throw new K(JSON.stringify(a.body),a.status);let s={},l=null;try{a.headers.forEach((u,i)=>{s[i]=u}),l=await a.json()}catch{}return{headers:s,body:l}},c={signUp:async(e,t,r)=>{t=o.toBackendParams(t),await L("POST",o.toBaseUrl(e,"users"),{user:t},S(null,r))},signIn:async(e,t,r)=>{t=o.toBackendParams(t);let n=await L("POST",o.toApiUrl(e,"auth/sign_in"),t,S(null,r));return Pt(n.headers)},signOut:async(e,t,r)=>{await L("DELETE",o.toApiUrl(e,"auth/sign_out"),null,S(t,r))},passwordResetInstructions:async(e,t,r)=>{t=o.toBackendParams(t),await L("POST",o.toBaseUrl(e,"users/password"),{user:t},S(null,r))},passwordReset:async(e,t,r)=>{t=o.toBackendParams(t),await L("PUT",o.toBaseUrl(e,"users/password"),{user:t},S(null,r))},getUser:async(e,t,r)=>{let n=await L("GET",o.toApiUrl(e,"users/me"),null,S(t,r));return o.toFrontendParams(n.body)},updateUser:async(e,t,r,n)=>{let a=t.avatar?.signedId,s={...o.toBackendParams(t),avatar:a},l=await L("PATCH",o.toApiUrl(e,"users/me"),{user:s},S(r,n));return o.toFrontendParams(l.body)},confirmationInstructions:async(e,t,r)=>{t=o.toBackendParams(t),await L("POST",o.toBaseUrl(e,"users/confirmation"),{user:t},S(null,r))},confirmation:async(e,t,r)=>{let n=o.toBaseUrl(e,"users/confirmation");t=o.toBackendParams(t),n=`${n}?${o.toGetParameters(t)}`,await L("GET",n,null,S(null,r))},get:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r)),r&&(l=`${l}?${o.toGetParameters(r)}`);let u=await L("GET",l,null,S(n,a));return o.toFrontendParams(u.body)},post:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r));let u=await L("POST",l,r,S(n,a));return o.toFrontendParams(u.body)},patch:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r));let u=await L("PATCH",l,r,S(n,a));return o.toFrontendParams(u.body)},put:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r));let u=await L("PUT",l,r,S(n,a));return o.toFrontendParams(u.body)},delete:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r)),r&&(l=`${l}?${o.toGetParameters(r)}`);let u=await L("DELETE",l,null,S(n,a));return o.toFrontendParams(u.body)},defaultHttpHeader:(e,t)=>S(e,t)};var ye=require("react");var P=()=>(0,ye.useContext)(ae);var le=e=>{let{backendUrl:t,authInfo:r,apiVersion:n}=P();return{call:(0,ve.useCallback)(async(s,l,u)=>{let i=e?o.cleanupPath(o.cleanupUrl(e)):null,m=o.cleanupPath(s),g=`${i?i+"/":""}${m}`;switch(l){case"POST":return c.post(t,g,u,r,n);case"PUT":return c.put(t,g,u,r,n);case"PATCH":return c.patch(t,g,u,r,n);case"DELETE":return c.delete(t,g,u,r,n);default:return c.get(t,g,u,r,n)}},[])}};var Fe=(e,t="GET",r,n)=>{let{backendUrl:a,authInfo:s,apiVersion:l}=P(),[u,i]=(0,Y.useState)(null),[m,g]=(0,Y.useState)(null),[D,w]=(0,Y.useState)(!1),{call:b}=le(),F=(0,Y.useCallback)(async d=>{try{w(!0),g(null),i(null);let f=await b(e,t,d||r);return i(f),w(!1),f}catch(f){g(f),w(!1)}},[]);return(0,Y.useEffect)(()=>{(async()=>n?.skipInitialCall||await F())()},[s,a,l]),{data:u,error:m,inProgress:D,callApi:F}};var k=require("react");var ze=e=>{let{backendUrl:t,authInfo:r,apiVersion:n}=P(),[a,s]=(0,k.useState)(null),[l,u]=(0,k.useState)(null),[i,m]=(0,k.useState)(!1),[g,D]=(0,k.useState)(null),w=(0,k.useMemo)(()=>o.toSnakeCaseString(e),[e]),b=(0,k.useCallback)(async C=>{D(null),m(!0);try{let z=await C();return m(!1),z}catch(z){return m(!1),D(z),null}},[]),F=(0,k.useCallback)(()=>b(async()=>{let C=await c.get(t,w,null,r,n);return u(C),C}),[t,r,n,w]),d=(0,k.useCallback)(C=>b(async()=>{let z=await c.get(t,`${w}/${C}`,null,r,n);return s(z),z}),[t,r,n,w]),f=(0,k.useCallback)(C=>b(async()=>{let z=await c.get(t,w,C,r,n);return u(z),z}),[t,r,n,w]),O=(0,k.useCallback)(C=>b(async()=>{let z=await c.post(t,w,C,r,n);return s(z),z}),[t,r,n,w]),U=(0,k.useCallback)((C,z)=>b(async()=>{let Ce=await c.patch(t,`${w}/${C}`,z,r,n);return s(Ce),Ce}),[t,r,n,w]),I=(0,k.useCallback)(C=>b(async()=>{await c.delete(t,`${w}/${C}`,null,r,n),s(null)}),[t,r,n,w]);return{record:a,records:l,inProgress:i,error:g,getAll:F,getOne:d,search:f,create:O,update:U,remove:I}};var v=require("react-bootstrap");var Re="a563a7ebb3e648e97f9484abfe6d2e49b279541947d0d1e8c32963c80c0b3f08",Tt=`._container_1c59p_1 {
    display: flex;
...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(Ie)){var e=document.createElement("style");e.id=Ie,e.textContent=_t,document.head.appendChild(e)}})();var A={container:"_container_1c59p_1",fieldContainer:"_fieldContainer_1c59p_8",fieldLabel:"_fieldLabel_1c59p_15",formField:"_formField_1c59p_19",fieldError:"_fieldError_1c59p_23",submitButton:"_submitButton_1c59p_32"};var Le=e=>{let{backendUrl:t,apiVersion:r,setAuthInfo:n}=P(),[a,s]=(0,R.useState)(!1),l=Q.object().shape({email:Q.string().email(e.invalidEmailErrorText||"Invalid email address.").required(e.emailRequiredErrorText||"The email address is required."),password:Q.string().min(e.minPasswordLength||8,e.passwordToShortErrorText||`The password is too short. It must have at least ${e.minPasswordLength||8} characters.`).required(e.passwordRequiredErrorText||"The password is required.")}).defined(),u=async m=>{s(!0);try{let g=await c.signIn(t,m,r);if(!g)throw"No authentication object returned";n(g),await e.onLoginSuccess(m.email,g,m.stayLoggedIn)}catch(g){e.onLoginError(g),s(!1)}};return R.default.createElement(Se.Formik,{initialValues:{email:"",password:"",stayLoggedIn:!1},onSubmit:m=>{u(m)},validationSchema:l},({errors:m,handleChange:g,handleSubmit:D})=>R.default.createElement("form",{onSubmit:D,className:e.containerClassName||A.container},R.default.createElement(M.default.Group,{id:"email-container",className:e.fieldContainerClassName||A.fieldContainer},R.default.createElement(M.default.Label,{className:e.fieldLabelClassName||A.fieldLabel},e.labelEmail||"Email address"),R.default.createElement(M.default.Control,{id:"email",type:"email",onChange:g,className:e.fieldInputClassName||A.formField,isInvalid:!!m.email}),R.default.createElement(M.default.Control.Feedback,{type:"invalid",className:e.fieldErrorClassName||A.fieldError},m.email)),R.default.createElement(M.default.Group,{id:"password-container",className:e.fieldContainerClassName||A.fieldContainer},R.default.createElement(M.default.Label,{className:e.fieldLabelClassName||A.fieldLabel},e.labelPassword||"Password"),R.default.createElement(M.default.Control,{id:"password",type:"password",onChange:g,className:e.fieldInputClassName||A.formField,isInvalid:!!m.password}),R.default.createElement(M.default.Control.Feedback,{type:"invalid",className:e.fieldErrorClassName||A.fieldError},m.password)),!e.hideStayLoggedIn&&R.default.createElement(M.default.Group,{id:"stay-logged-in-container",className:e.fieldCheckboxContainerClassName||A.fieldContainer},R.default.createElement(M.default.Check,{id:"stayLoggedIn",className:e.fieldCheckboxInputClassName||A.formField,type:"checkbox",label:e.labelStayLoggedIn||"Stay logged in.",onChange:g})),!a&&R.default.createElement("div",{className:e.submitButtonContainerClassName||"ez-on-rails-form-submit-container"},R.default.createElement(ke.default,{variant:"primary",type:"submit",className:e.submitButtonClassName||A.submitButton},e.labelSubmitButton||"Login"))))};var H=h(require("react")),me=h(require("yup"));var Ae=require("formik"),ee=h(require("react-bootstrap/Form")),Be=h(require("react-bootstrap/Button"));var Ue="22f0744f7499dc4dc3931a831ce214b61be2117ea7faef8309e6e4972d40a28b",wt=`._container_1c59p_1 {
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: flex-start;
...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(Ue)){var e=document.createElement("style");e.id=Ue,e.textContent=wt,document.head.appendChild(e)}})();var X={container:"_container_1c59p_1",fieldContainer:"_fieldContainer_1c59p_8",fieldLabel:"_fieldLabel_1c59p_15",formField:"_formField_1c59p_19",fieldError:"_fieldError_1c59p_23",submitButton:"_submitButton_1c59p_32"};var Me=e=>{let{backendUrl:t,apiVersion:r}=P(),[n,a]=(0,H.useState)(!1),s=me.object().shape({email:me.string().email(e.invalidEmailErrorText||"Invalid email address.").required(e.emailRequiredErrorText||"The email address is required.")}).defined(),l=i=>{a(!0),c.passwordResetInstructions(t,i,r).then(()=>{e.onLostPasswordSuccess(i.email),a(!1)}).catch(m=>{e.onLostPasswordError(m),a(!1)})};return H.default.createElement(Ae.Formik,{initialValues:{email:""},onSubmit:i=>{l(i)},validationSchema:s},({errors:i,handleChange:m,handleSubmit:g})=>H.default.createElement("form",{onSubmit:g,className:e.containerClassName||X.container},H.default.createElement(ee.default.Group,{id:"email-container",className:e.fieldContainerClassName||X.fieldContainer},H.default.createElement(ee.default.Label,{className:e.fieldLabelClassName||X.fieldLabel},e.labelEmail||"Email address"),H.default.createElement(ee.default.Control,{id:"email",type:"email",onChange:m,className:e.fieldInputClassName||X.formField,isInvalid:!!i.email}),H.default.createElement(ee.default.Control.Feedback,{type:"invalid",className:e.fieldErrorClassName||X.fieldError},i.email)),!n&&H.default.createElement("div",{className:e.submitButtonContainerClassName||"ez-on-rails-form-submit-container"},H.default.createElement(Be.default,{variant:"primary",type:"submit",className:e.submitButtonClassName||X.submitButton},e.labelSubmitButton||"Submit"))))};var V=h(require("react")),de=h(require("yup"));var Ve=require("formik"),te=h(require("react-bootstrap/Form")),qe=h(require("react-bootstrap/Button"));var He="08faa1fc3d8d44ac793d64f9044157186548fdbc461a48c463085815552fa55e",yt=`._container_1c59p_1 {
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: flex-start;
...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(je)){var e=document.createElement("style");e.id=je,e.textContent=Ft,document.head.appendChild(e)}})();var be={dropzoneContainer:"_dropzoneContainer_14oft_1",pastezoneContainer:"_pastezoneContainer_14oft_19"};var zt=(e,t)=>`rails/active_storage/blobs/${e}/${t}`,ce=e=>{let{backendUrl:t,authInfo:r,apiVersion:n}=P(),[a,s]=(0,We.useState)(0),l=x.default.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:"32",height:"32",fill:"currentColor",className:"bi bi-cloud-arrow-up",viewBox:"0 0 16 16"},x.default.createElement("path",{fillRule:"evenodd",d:"M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z"}),x.default.createElement("path",{d:"M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383zm.653.757c-.757.653-1.153 1.44-1.153 2.056v.448l-.445.049C2.064 6.805 1 7.952 1 9.318 1 10.785 2.23 12 3.781 12h8.906C13.98 12 15 10.988 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3a4.53 4.53 0 0 0-2.941 1.1z"})),u=async d=>{await c.delete(t,`active_storage/blobs/${d}`,null,r,n)},i=async(d,f)=>{await u(f);let O=[...e.files];O=O.filter(U=>f!==U.signedId),e.onChange(O),d.stopPropagation()},m=d=>{d.loaded/d.total>=.9999999},g=d=>{if(d.length){if(e.maxFiles){let f=e.maxFiles-(e.files.length+a);if(f<d.length&&e.onMaxFilesError(e.maxFiles),f<=0)return;d=d.slice(0,f)}if(e.maxSize){let f=d.filter(O=>O.size<=e.maxSize);f.length<d.length&&e.onMaxSizeError(e.maxSize),d=f}s(f=>f+d.length),d.forEach(f=>{new Ye.DirectUpload(f,o.toApiUrl(t,"active_storage/blobs/create_direct_upload"),{directUploadWillCreateBlobWithXHR:U=>{let I=c.defaultHttpHeader(r,n);Object.keys(I).forEach(C=>{U.setRequestHeader(C,I[C])}),U.upload.addEventListener("progress",m)}}).create((U,I)=>{if(s(C=>C-1),!U){let C={signedId:I.signed_id};f.type.includes("image")?C.path=zt(I.signed_id,I.filename):C.filename=I.filename;let z=e.files;z.push(C),e.onChange([...z])}})})}},D=d=>{if(!d.clipboardData)return;let f=d.clipboardData.items;if(f===void 0)return;let O=[];for(let U of f){if(e.accept&&!Object.keys(e.accept).some(C=>U.type.match(C)))continue;let I=U.getAsFile();I&&O.push(I)}g(O)},w=e.files.map(d=>x.default.createElement("div",{key:d.signedId,className:"card w-25 animate__animated animate__fadeIn mb-4",style:{flex:"0 0 auto"}},x.default.createElement("div",{className:"card-header p-1"},x.default.createElement("button",{onClick:f=>i(f,d.signedId||""),type:"button",className:"close","aria-label":"Close"},x.default.createElement("span",{"aria-hidden":"true"},"\xD7"))),x.default.createElement("div",{className:"d-flex justify-content-center align-items-center w-100 h-100"},x.default.createElement("img",{src:o.toBaseUrl(t,d.path||""),alt:d.filename,className:"d-block mw-100 m-auto m-0 rounded p-1"})))),b=[];for(let d=0;d<a;d++)b.push(x.default.createElement("div",{key:d,className:"card w-25 mb-4",style:{flex:"0 0 auto"}},x.default.createElement("div",{className:"d-flex justify-content-center align-items-center w-100 h-100"},x.default.createElement("div",{className:"p-4 text-center"},x.default.createElement("div",{className:"spinner-border",role:"status"},x.default.createElement("span",{className:"sr-only"},"Loading..."))))));let F=d=>{d.some(f=>f.errors[0].code===W.ErrorCode.TooManyFiles)&&e.onMaxFilesError(e.maxFiles),d.some(f=>f.errors[0].code===W.ErrorCode.FileInvalidType)&&e.onInvalidTypeError(e.accept),d.some(f=>f.errors[0].code===W.ErrorCode.FileTooLarge)&&e.onMaxSizeError(e.maxSize)};return x.default.createElement("div",null,e.pasteZone&&x.default.createElement("input",{type:"text",className:`w-100 p-2 ${be.pastezoneContainer}`,value:e.textPastezone||"Copy and paste some files here",onPaste:D,readOnly:!0}),x.default.createElement(W.default,{onDropAccepted:g,multiple:e.multiple,maxFiles:e.maxFiles,maxSize:e.maxSize,onDropRejected:F,accept:e.accept},({getRootProps:d,getInputProps:f}=(0,W.useDropzone)())=>x.default.createElement("section",null,x.default.createElement("div",{...d(),className:`${be.dropzoneContainer} p-4 ${e.className}`},x.default.createElement("input",{...f()}),x.default.createElement("p",{className:"m-0"},e.textDropzone||"Drag 'n' drop some files here, or click to select files"),w.length>0?x.default.createElement("aside",{className:"card-deck justify-content-center w-100 m-4"},w):x.default.createElement("div",{className:"m-0"},e.customIcon||l),b.length>0&&x.default.createElement("aside",{className:"card-deck justify-content-center w-100 m-4"},b)))))};var Ze=require("formik"),G=h(require("react-bootstrap/Form")),Je=h(require("react-bootstrap/Button")),N=h(require("react")),J=h(require("yup"));var Xe="1ced5992128b2373e529afb6c9d18e1a38e47e17bc21e470c8d685fbef280e02",Rt=`._container_1c59p_1 {
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: flex-start;
