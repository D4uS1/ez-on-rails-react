"use strict";var ot=Object.create;var ne=Object.defineProperty;var lt=Object.getOwnPropertyDescriptor;var mt=Object.getOwnPropertyNames;var dt=Object.getPrototypeOf,ct=Object.prototype.hasOwnProperty;var ut=(e,t)=>{for(var r in t)ne(e,r,{get:t[r],enumerable:!0})},Pe=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of mt(t))!ct.call(e,a)&&a!==r&&ne(e,a,{get:()=>t[a],enumerable:!(n=lt(t,a))||n.enumerable});return e};var h=(e,t,r)=>(r=e!=null?ot(dt(e)):{},Pe(t||!e||!e.__esModule?ne(r,"default",{value:e,enumerable:!0}):r,e)),ft=e=>Pe(ne({},"__esModule",{value:!0}),e);var St={};ut(St,{ActiveStorageDropzone:()=>ce,DevelopmentHint:()=>$e,EzOnRails:()=>Te,EzOnRailsHttp:()=>Ot,EzOnRailsHttpError:()=>K,EzOnRailsIntegrations:()=>It,LoginForm:()=>Le,LostPasswordForm:()=>He,ProtectedPage:()=>Qe,RegistrationForm:()=>Oe,ResendConfirmationForm:()=>De,ResetPasswordForm:()=>Ke,UpdateUserForm:()=>rt,useEzApi:()=>Fe,useEzApiHttpClient:()=>le,useEzOnRails:()=>x,useEzScaff:()=>ze});module.exports=ft(St);var j=h(require("react"));var xe=require("react"),ae=(0,xe.createContext)({apiVersion:"1.0",backendUrl:"http://localhost:3000",authInfo:null,setBackendUrl:e=>{},setAuthInfo:e=>{},setApiVersion:e=>{}});var Te=e=>{let[t,r]=(0,j.useState)(e.backendUrl),[n,a]=(0,j.useState)(e.authInfo||null),[s,l]=(0,j.useState)(e.apiVersion),u=(0,j.useMemo)(()=>{let i={backendUrl:t,authInfo:n||null,apiVersion:s,setBackendUrl:r,setAuthInfo:a,setApiVersion:l};return i.backendUrl.endsWith("/")&&(i.backendUrl=i.backendUrl.slice(0,-1)),i},[t,n,s]);return j.default.createElement(ae.Provider,{value:u},e.children)};var E=h(require("react")),B=h(require("yup")),Ne=require("formik");var Y=require("react");var ve=require("react");var oe=require("convert-keys"),fe=e=>e.startsWith("/")?e.slice(1):e,pe=e=>e.endsWith("/")?e.slice(0,-1):e,pt=(e,t)=>`${pe(e)}/${fe(t)}`,gt=(e,t)=>`${pe(e)}/api/${fe(t)}`,bt=e=>(e=e.replace(/[A-Z]/g,(t,r)=>r===0?t.toLowerCase():"_"+t.toLowerCase()),e=e.replace(/::_/g,"/"),e=e.replace(/\/_/g,"/"),e),_e=e=>e&&(0,oe.toSnake)(e),we=e=>e&&(0,oe.toCamel)(e),Et=e=>Object.keys(e).map(t=>t+"="+e[t]).join("&"),ie=e=>typeof e=="string"&&/^\d{4}-\d{2}-\d{2}/.test(e)?new Date(e):Array.isArray(e)?e.map(t=>ie(t)):(typeof e=="object"&&Object.keys(e).forEach(t=>{e[t]=ie(e[t])}),e),se=e=>e instanceof Date?e.toISOString():Array.isArray(e)?e.map(t=>se(t)):(typeof e=="object"&&Object.keys(e).forEach(t=>{e[t]=se(e[t])}),e),ht=e=>se(_e(e)),Ct=e=>!e||typeof e!="object"?e:ie(we(e)),o={cleanupUrl:pe,cleanupPath:fe,toBaseUrl:pt,toApiUrl:gt,toSnakeCase:_e,toSnakeCasePath:bt,toCamelCase:we,toGetParameters:Et,toDates:ie,toDateStrings:se,toBackendParams:ht,toFrontendParams:Ct};var K=class extends Error{httpStatusCode;constructor(t,r){super(),this.message=t,this.httpStatusCode=r}};var Pt=e=>{if(e)return{uid:e.uid,client:e.client,expiry:e.expiry,"token-type":e.tokenType,"access-token":e.accessToken}},xt=e=>({uid:e.uid,client:e.client,expiry:e.expiry,tokenType:e["token-type"],accessToken:e["access-token"]}),S=(e,t)=>({"Content-Type":"application/json",Accept:"application/json","api-version":t,...Pt(e)}),L=async(e,t,r,n)=>{let a=await fetch(t,{method:e,headers:n,body:r?JSON.stringify(r):null});if(a.status>=400)throw new K(JSON.stringify(a.body),a.status);let s={},l=null;try{a.headers.forEach((u,i)=>{s[i]=u}),l=await a.json()}catch{}return{headers:s,body:l}},c={signUp:async(e,t,r)=>{t=o.toBackendParams(t),await L("POST",o.toBaseUrl(e,"users"),{user:t},S(null,r))},signIn:async(e,t,r)=>{t=o.toBackendParams(t);let n=await L("POST",o.toApiUrl(e,"auth/sign_in"),t,S(null,r));return xt(n.headers)},signOut:async(e,t,r)=>{await L("DELETE",o.toApiUrl(e,"auth/sign_out"),null,S(t,r))},passwordResetInstructions:async(e,t,r)=>{t=o.toBackendParams(t),await L("POST",o.toBaseUrl(e,"users/password"),{user:t},S(null,r))},passwordReset:async(e,t,r)=>{t=o.toBackendParams(t),await L("PUT",o.toBaseUrl(e,"users/password"),{user:t},S(null,r))},getUser:async(e,t,r)=>{let n=await L("GET",o.toApiUrl(e,"users/me"),null,S(t,r));return o.toFrontendParams(n.body)},updateUser:async(e,t,r,n)=>{let a=t.avatar?.signedId,s={...o.toBackendParams(t),avatar:a},l=await L("PATCH",o.toApiUrl(e,"users/me"),{user:s},S(r,n));return o.toFrontendParams(l.body)},confirmationInstructions:async(e,t,r)=>{t=o.toBackendParams(t),await L("POST",o.toBaseUrl(e,"users/confirmation"),{user:t},S(null,r))},confirmation:async(e,t,r)=>{let n=o.toBaseUrl(e,"users/confirmation");t=o.toBackendParams(t),n=`${n}?${o.toGetParameters(t)}`,await L("GET",n,null,S(null,r))},get:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r)),r&&(l=`${l}?${o.toGetParameters(r)}`);let u=await L("GET",l,null,S(n,a));return o.toFrontendParams(u.body)},post:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r));let u=await L("POST",l,r,S(n,a));return o.toFrontendParams(u.body)},patch:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r));let u=await L("PATCH",l,r,S(n,a));return o.toFrontendParams(u.body)},put:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r));let u=await L("PUT",l,r,S(n,a));return o.toFrontendParams(u.body)},delete:async(e,t,r,n=null,a="1.0",s=void 0)=>{let l=o.toApiUrl(e,t);r&&(r=o.toBackendParams(r)),s&&(r=s(r)),r&&(l=`${l}?${o.toGetParameters(r)}`);let u=await L("DELETE",l,null,S(n,a));return o.toFrontendParams(u.body)},defaultHttpHeader:(e,t)=>S(e,t)};var ye=require("react");var x=()=>(0,ye.useContext)(ae);var le=e=>{let{backendUrl:t,authInfo:r,apiVersion:n}=x();return{call:(0,ve.useCallback)(async(s,l,u)=>{let i=e?o.cleanupPath(o.cleanupUrl(e)):null,m=o.cleanupPath(s),g=`${i?i+"/":""}${m}`;switch(l){case"POST":return c.post(t,g,u,r,n);case"PUT":return c.put(t,g,u,r,n);case"PATCH":return c.patch(t,g,u,r,n);case"DELETE":return c.delete(t,g,u,r,n);default:return c.get(t,g,u,r,n)}},[])}};var Fe=(e,t="GET",r,n)=>{let{backendUrl:a,authInfo:s,apiVersion:l}=x(),[u,i]=(0,Y.useState)(null),[m,g]=(0,Y.useState)(null),[D,w]=(0,Y.useState)(!1),{call:b}=le(),F=(0,Y.useCallback)(async d=>{try{w(!0),g(null),i(null);let f=await b(e,t,d||r);return i(f),w(!1),f}catch(f){g(f),w(!1)}},[]);return(0,Y.useEffect)(()=>{(async()=>n?.skipInitialCall||await F())()},[s,a,l]),{data:u,error:m,inProgress:D,callApi:F}};var k=require("react");var ze=e=>{let{backendUrl:t,authInfo:r,apiVersion:n}=x(),[a,s]=(0,k.useState)(null),[l,u]=(0,k.useState)(null),[i,m]=(0,k.useState)(!1),[g,D]=(0,k.useState)(null),w=(0,k.useMemo)(()=>o.toSnakeCasePath(e),[e]),b=(0,k.useCallback)(async C=>{D(null),m(!0);try{let z=await C();return m(!1),z}catch(z){return m(!1),D(z),null}},[]),F=(0,k.useCallback)(()=>b(async()=>{let C=await c.get(t,w,null,r,n);return u(C),C}),[t,r,n,w]),d=(0,k.useCallback)(C=>b(async()=>{let z=await c.get(t,`${w}/${C}`,null,r,n);return s(z),z}),[t,r,n,w]),f=(0,k.useCallback)(C=>b(async()=>{let z=await c.get(t,w,C,r,n);return u(z),z}),[t,r,n,w]),O=(0,k.useCallback)(C=>b(async()=>{let z=await c.post(t,w,C,r,n);return s(z),z}),[t,r,n,w]),U=(0,k.useCallback)((C,z)=>b(async()=>{let Ce=await c.patch(t,`${w}/${C}`,z,r,n);return s(Ce),Ce}),[t,r,n,w]),I=(0,k.useCallback)(C=>b(async()=>{await c.delete(t,`${w}/${C}`,null,r,n),s(null)}),[t,r,n,w]);return{record:a,records:l,inProgress:i,error:g,getAll:F,getOne:d,search:f,create:O,update:U,remove:I}};var v=require("react-bootstrap");var Re="8304f043249ef35d9290309c0860e99b5ef00d63c3bec36f87e886b391b8f83c",Tt=`._container_1c59p_1 {
    display: flex;
...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(Ue)){var e=document.createElement("style");e.id=Ue,e.textContent=wt,document.head.appendChild(e)}})();var X={container:"_container_1c59p_1",fieldContainer:"_fieldContainer_1c59p_8",fieldLabel:"_fieldLabel_1c59p_15",formField:"_formField_1c59p_19",fieldError:"_fieldError_1c59p_23",submitButton:"_submitButton_1c59p_32"};var He=e=>{let{backendUrl:t,apiVersion:r}=x(),[n,a]=(0,M.useState)(!1),s=me.object().shape({email:me.string().email(e.invalidEmailErrorText||"Invalid email address.").required(e.emailRequiredErrorText||"The email address is required.")}).defined(),l=i=>{a(!0),c.passwordResetInstructions(t,i,r).then(()=>{e.onLostPasswordSuccess(i.email),a(!1)}).catch(m=>{e.onLostPasswordError(m),a(!1)})};return M.default.createElement(Ae.Formik,{initialValues:{email:""},onSubmit:i=>{l(i)},validationSchema:s},({errors:i,handleChange:m,handleSubmit:g})=>M.default.createElement("form",{onSubmit:g,className:e.containerClassName||X.container},M.default.createElement(ee.default.Group,{id:"email-container",className:e.fieldContainerClassName||X.fieldContainer},M.default.createElement(ee.default.Label,{className:e.fieldLabelClassName||X.fieldLabel},e.labelEmail||"Email address"),M.default.createElement(ee.default.Control,{id:"email",type:"email",onChange:m,className:e.fieldInputClassName||X.formField,isInvalid:!!i.email}),M.default.createElement(ee.default.Control.Feedback,{type:"invalid",className:e.fieldErrorClassName||X.fieldError},i.email)),!n&&M.default.createElement("div",{className:e.submitButtonContainerClassName||"ez-on-rails-form-submit-container"},M.default.createElement(Be.default,{variant:"primary",type:"submit",className:e.submitButtonClassName||X.submitButton},e.labelSubmitButton||"Submit"))))};var V=h(require("react")),de=h(require("yup"));var Ve=require("formik"),te=h(require("react-bootstrap/Form")),qe=h(require("react-bootstrap/Button"));var Me="9399e7ba5164cf8c18bb2a8c88a7528ed003fc1c1628f21e6c6a8b8410dadd85",yt=`._container_1c59p_1 {
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: flex-start;
