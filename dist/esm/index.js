...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(xe)){var e=document.createElement("style");e.id=xe,e.textContent=it,document.head.appendChild(e)}})();var k={container:"_container_1c59p_1",fieldContainer:"_fieldContainer_1c59p_8",fieldLabel:"_fieldLabel_1c59p_15",formField:"_formField_1c59p_19",fieldError:"_fieldError_1c59p_23",submitButton:"_submitButton_1c59p_32"};var mt=e=>{let{backendUrl:t,apiVersion:r,setAuthInfo:n}=x(),[s,i]=lt(!1),l=X.object().shape({email:X.string().email(e.invalidEmailErrorText||"Invalid email address.").required(e.emailRequiredErrorText||"The email address is required."),password:X.string().min(e.minPasswordLength||8,e.passwordToShortErrorText||`The password is too short. It must have at least ${e.minPasswordLength||8} characters.`).required(e.passwordRequiredErrorText||"The password is required.")}).defined(),u=async m=>{i(!0);try{let p=await c.signIn(t,m,r);if(!p)throw"No authentication object returned";n(p),await e.onLoginSuccess(m.email,p,m.stayLoggedIn)}catch(p){e.onLoginError(p),i(!1)}};return I.createElement(st,{initialValues:{email:"",password:"",stayLoggedIn:!1},onSubmit:m=>{u(m)},validationSchema:l},({errors:m,handleChange:p,handleSubmit:B})=>I.createElement("form",{onSubmit:B,className:e.containerClassName||k.container},I.createElement(M.Group,{id:"email-container",className:e.fieldContainerClassName||k.fieldContainer},I.createElement(M.Label,{className:e.fieldLabelClassName||k.fieldLabel},e.labelEmail||"Email address"),I.createElement(M.Control,{id:"email",type:"email",onChange:p,className:e.fieldInputClassName||k.formField,isInvalid:!!m.email}),I.createElement(M.Control.Feedback,{type:"invalid",className:e.fieldErrorClassName||k.fieldError},m.email)),I.createElement(M.Group,{id:"password-container",className:e.fieldContainerClassName||k.fieldContainer},I.createElement(M.Label,{className:e.fieldLabelClassName||k.fieldLabel},e.labelPassword||"Password"),I.createElement(M.Control,{id:"password",type:"password",onChange:p,className:e.fieldInputClassName||k.formField,isInvalid:!!m.password}),I.createElement(M.Control.Feedback,{type:"invalid",className:e.fieldErrorClassName||k.fieldError},m.password)),!e.hideStayLoggedIn&&I.createElement(M.Group,{id:"stay-logged-in-container",className:e.fieldCheckboxContainerClassName||k.fieldContainer},I.createElement(M.Check,{id:"stayLoggedIn",className:e.fieldCheckboxInputClassName||k.formField,type:"checkbox",label:e.labelStayLoggedIn||"Stay logged in.",onChange:p})),!s&&I.createElement("div",{className:e.submitButtonContainerClassName||"ez-on-rails-form-submit-container"},I.createElement(ot,{variant:"primary",type:"submit",className:e.submitButtonClassName||k.submitButton},e.labelSubmitButton||"Login"))))};import V,{useState as ct}from"react";import*as te from"yup";import{Formik as ut}from"formik";import ee from"react-bootstrap/Form";import ft from"react-bootstrap/Button";var Pe="89ae8ceb5715a97634b604b77e8db8c51a73ff369719b1b41c5393911516fb24",dt=`._container_1c59p_1 {
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: flex-start;
