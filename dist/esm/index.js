...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(_e)){var e=document.createElement("style");e.id=_e,e.textContent=Pt,document.head.appendChild(e)}})();var de={container:"_container_q2u8x_1",text:"_text_q2u8x_13"};var Tt=e=>{let[t,r]=xt(e.visible),n=()=>{r(!0)};return t?we.createElement("div",{onClick:()=>{r(!1),setTimeout(n,e.dismissTimeout||2e4)},className:de.container},we.createElement("span",{className:de.text},"development")):null};import C from"react";import*as ve from"@rails/activestorage";import{useState as wt}from"react";import yt,{ErrorCode as ue,useDropzone as vt}from"react-dropzone";var ye="f80e4548a667aa9566d6de6247255aeceef988e4326ecc030c69f34ac05ef54c",_t=`._dropzoneContainer_14oft_1 {
  display: flex;
  flex-direction: column;
  align-items: center;
  border-width: 2px;
