import Se,{useMemo as Ue,useState as J}from"react";import{createContext as Ie}from"react";var Z=Ie({apiVersion:"1.0",backendUrl:"http://localhost:3000",authInfo:null,setBackendUrl:e=>{},setAuthInfo:e=>{},setApiVersion:e=>{},setOnUnauthorizedCallback:e=>{}});var Le=e=>{let[t,r]=J(e.backendUrl),[n,o]=J(e.authInfo||null),[i,m]=J(e.apiVersion),[p,a]=J(e.onUnauthorizedCallback),l=Ue(()=>{let f={backendUrl:t,authInfo:n||null,apiVersion:i,setBackendUrl:r,setAuthInfo:o,setApiVersion:m,setOnUnauthorizedCallback:a};return f.backendUrl.endsWith("/")&&(f.backendUrl=f.backendUrl.slice(0,-1)),f},[t,n,i]);return Se.createElement(Z.Provider,{value:l},e.children)};import C,{useState as rt}from"react";import*as A from"yup";import{Formik as nt}from"formik";import{useCallback as Ze,useEffect as Je,useState as me}from"react";import{useCallback as Xe}from"react";import{toCamel as Ae,toSnake as Be}from"convert-keys";var oe=e=>e.startsWith("/")?e.slice(1):e,se=e=>e.endsWith("/")?e.slice(0,-1):e,He=(e,t)=>`${se(e)}/${oe(t)}`,Me=(e,t)=>`${se(e)}/api/${oe(t)}`,Ve=e=>(e=e.replace(/[A-Z]/g,(t,r)=>r===0?t.toLowerCase():"_"+t.toLowerCase()),e=e.replace(/::_/g,"/"),e=e.replace(/\/_/g,"/"),e),Ee=e=>e&&Be(e),he=e=>e&&Ae(e),qe=e=>Object.keys(e).map(t=>t+"="+e[t]).join("&"),K=e=>typeof e=="string"&&/^\d{4}-\d{2}-\d{2}/.test(e)?new Date(e):Array.isArray(e)?e.map(t=>K(t)):(e!==null&&typeof e=="object"&&Object.keys(e).forEach(t=>{e[t]=K(e[t])}),e),Q=e=>e instanceof Date?e.toISOString():Array.isArray(e)?e.map(t=>Q(t)):(e!==null&&typeof e=="object"&&Object.keys(e).forEach(t=>{e[t]=Q(e[t])}),e),De=e=>Q(Ee(e)),Ge=e=>!e||typeof e!="object"?e:K(he(e)),je=e=>e?!!(typeof e=="object"&&e.httpStatusCode):!1,s={cleanupUrl:se,cleanupPath:oe,toBaseUrl:He,toApiUrl:Me,toSnakeCase:Ee,toSnakeCasePath:Ve,toCamelCase:he,toGetParameters:qe,toDates:K,toDateStrings:Q,toBackendParams:De,toFrontendParams:Ge,isEzOnRailsHttpError:je};var W=class extends Error{httpStatusCode;constructor(t,r){super(),this.message=t,this.httpStatusCode=r}};var $e=e=>{if(e)return{uid:e.uid,client:e.client,expiry:e.expiry,"token-type":e.tokenType,"access-token":e.accessToken}},Ye=e=>({uid:e.uid,client:e.client,expiry:e.expiry,tokenType:e["token-type"],accessToken:e["access-token"]}),O=(e,t)=>({"Content-Type":"application/json",Accept:"application/json","api-version":t,...$e(e)}),k=async(e,t,r,n)=>{let o=await fetch(t,{method:e,headers:n,body:r?JSON.stringify(r):null});if(o.status>=400)throw new W(JSON.stringify(o.body),o.status);let i={},m=null;try{o.headers.forEach((p,a)=>{i[a]=p}),m=await o.json()}catch{}return{headers:i,body:m}},c={signUp:async(e,t,r)=>{t=s.toBackendParams(t),await k("POST",s.toBaseUrl(e,"users"),{user:t},O(null,r))},signIn:async(e,t,r)=>{t=s.toBackendParams(t);let n=await k("POST",s.toApiUrl(e,"auth/sign_in"),t,O(null,r));return Ye(n.headers)},signOut:async(e,t,r)=>{await k("DELETE",s.toApiUrl(e,"auth/sign_out"),null,O(t,r))},passwordResetInstructions:async(e,t,r)=>{t=s.toBackendParams(t),await k("POST",s.toBaseUrl(e,"users/password"),{user:t},O(null,r))},passwordReset:async(e,t,r)=>{t=s.toBackendParams(t),await k("PUT",s.toBaseUrl(e,"users/password"),{user:t},O(null,r))},getUser:async(e,t,r)=>{let n=await k("GET",s.toApiUrl(e,"users/me"),null,O(t,r));return s.toFrontendParams(n.body)},updateUser:async(e,t,r,n)=>{let o=t.avatar?.signedId,i={...s.toBackendParams(t),avatar:o},m=await k("PATCH",s.toApiUrl(e,"users/me"),{user:i},O(r,n));return s.toFrontendParams(m.body)},confirmationInstructions:async(e,t,r)=>{t=s.toBackendParams(t),await k("POST",s.toBaseUrl(e,"users/confirmation"),{user:t},O(null,r))},confirmation:async(e,t,r)=>{let n=s.toBaseUrl(e,"users/confirmation");t=s.toBackendParams(t),n=`${n}?${s.toGetParameters(t)}`,await k("GET",n,null,O(null,r))},get:async(e,t,r,n=null,o="1.0",i=void 0)=>{let m=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r)),r&&(m=`${m}?${s.toGetParameters(r)}`);let p=await k("GET",m,null,O(n,o));return s.toFrontendParams(p.body)},post:async(e,t,r,n=null,o="1.0",i=void 0)=>{let m=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r));let p=await k("POST",m,r,O(n,o));return s.toFrontendParams(p.body)},patch:async(e,t,r,n=null,o="1.0",i=void 0)=>{let m=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r));let p=await k("PATCH",m,r,O(n,o));return s.toFrontendParams(p.body)},put:async(e,t,r,n=null,o="1.0",i=void 0)=>{let m=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r));let p=await k("PUT",m,r,O(n,o));return s.toFrontendParams(p.body)},delete:async(e,t,r,n=null,o="1.0",i=void 0)=>{let m=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r)),r&&(m=`${m}?${s.toGetParameters(r)}`);let p=await k("DELETE",m,null,O(n,o));return s.toFrontendParams(p.body)},defaultHttpHeader:(e,t)=>O(e,t)};import{useContext as We}from"react";var P=()=>We(Z);var le=e=>{let{backendUrl:t,authInfo:r,apiVersion:n,onUnauthorizedCallback:o}=P();return{call:Xe(async(m,p,a)=>{let l=e?s.cleanupPath(s.cleanupUrl(e)):null,f=s.cleanupPath(m),F=`${l?l+"/":""}${f}`;try{switch(p){case"POST":return c.post(t,F,a,r,n);case"PUT":return c.put(t,F,a,r,n);case"PATCH":return c.patch(t,F,a,r,n);case"DELETE":return c.delete(t,F,a,r,n);default:return c.get(t,F,a,r,n)}}catch(E){throw!s.isEzOnRailsHttpError(E)||E.httpStatusCode!==401||!o||o(),E}},[r,n,t,e])}};var Ke=(e,t="GET",r,n)=>{let{backendUrl:o,authInfo:i,apiVersion:m}=P(),[p,a]=me(null),[l,f]=me(null),[F,E]=me(!1),{call:g}=le(),y=Ze(async d=>{try{E(!0),f(null),a(null);let u=await g(e,t,d||r);return a(u),E(!1),u}catch(u){f(u),E(!1)}},[e]);return Je(()=>{(async()=>n?.skipInitialCall||await y())()},[i,o,m,e]),{data:p,error:l,inProgress:F,callApi:y}};import{useCallback as G,useMemo as Qe,useState as ee}from"react";var et=e=>{let{backendUrl:t,authInfo:r,apiVersion:n}=P(),[o,i]=ee(null),[m,p]=ee(null),[a,l]=ee(!1),[f,F]=ee(null),E=Qe(()=>s.toSnakeCasePath(e),[e]),g=G(async h=>{F(null),l(!0);try{let z=await h();return l(!1),z}catch(z){return l(!1),F(z),null}},[]),y=G(()=>g(async()=>{let h=await c.get(t,E,null,r,n);return p(h),h}),[t,r,n,E]),d=G(h=>g(async()=>{let z=await c.get(t,`${E}/${h}`,null,r,n);return i(z),z}),[t,r,n,E]),u=G(h=>g(async()=>{let z=await c.get(t,E,h,r,n);return p(z),z}),[t,r,n,E]),R=G(h=>g(async()=>{let z=await c.post(t,E,h,r,n);return i(z),z}),[t,r,n,E]),S=G((h,z)=>g(async()=>{let be=await c.patch(t,`${E}/${h}`,z,r,n);return i(be),be}),[t,r,n,E]),N=G(h=>g(async()=>{await c.delete(t,`${E}/${h}`,null,r,n),i(null)}),[t,r,n,E]);return{record:o,records:m,inProgress:a,error:f,getAll:y,getOne:d,search:u,create:R,update:S,remove:N}};import{Button as at,Form as v}from"react-bootstrap";var Ce="7e6e9d3476df316f599dacca7b14adb07957a7b8dc1d0e9b7c5e39cfe0affcbc",tt=`._container_1c59p_1 {
    display: flex;
