...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(xe)){var e=document.createElement("style");e.id=xe,e.textContent=ct,document.head.appendChild(e)}})();var j={container:"_container_1c59p_1",fieldContainer:"_fieldContainer_1c59p_8",fieldLabel:"_fieldLabel_1c59p_15",formField:"_formField_1c59p_19",fieldError:"_fieldError_1c59p_23",submitButton:"_submitButton_1c59p_32"};var gt=e=>{let{backendUrl:t,apiVersion:r}=x(),[n,i]=ut(!1),o=re.object().shape({email:re.string().email(e.invalidEmailErrorText||"Invalid email address.").required(e.emailRequiredErrorText||"The email address is required.")}).defined(),m=a=>{i(!0),c.passwordResetInstructions(t,a,r).then(()=>{e.onLostPasswordSuccess(a.email),i(!1)}).catch(l=>{e.onLostPasswordError(l),i(!1)})};return V.createElement(ft,{initialValues:{email:""},onSubmit:a=>{m(a)},validationSchema:o},({errors:a,handleChange:l,handleSubmit:f})=>V.createElement("form",{onSubmit:f,className:e.containerClassName||j.container},V.createElement(te.Group,{id:"email-container",className:e.fieldContainerClassName||j.fieldContainer},V.createElement(te.Label,{className:e.fieldLabelClassName||j.fieldLabel},e.labelEmail||"Email address"),V.createElement(te.Control,{id:"email",type:"email",onChange:l,className:e.fieldInputClassName||j.formField,isInvalid:!!a.email}),V.createElement(te.Control.Feedback,{type:"invalid",className:e.fieldErrorClassName||j.fieldError},a.email)),!n&&V.createElement("div",{className:e.submitButtonContainerClassName||"ez-on-rails-form-submit-container"},V.createElement(pt,{variant:"primary",type:"submit",className:e.submitButtonClassName||j.submitButton},e.labelSubmitButton||"Submit"))))};import q,{useState as Et}from"react";import*as ae from"yup";import{Formik as ht}from"formik";import ne from"react-bootstrap/Form";import Ct from"react-bootstrap/Button";var Te="01e75d1f35baabcd0c174cd14cfbc3249ab48298c51ea2e404dd7e3b02503228",bt=`._container_1c59p_1 {
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: flex-start;
...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(_e)){var e=document.createElement("style");e.id=_e,e.textContent=xt,document.head.appendChild(e)}})();var de={container:"_container_q2u8x_1",text:"_text_q2u8x_13"};var _t=e=>{let[t,r]=Tt(e.visible),n=()=>{r(!0)};return t?we.createElement("div",{onClick:()=>{r(!1),setTimeout(n,e.dismissTimeout||2e4)},className:de.container},we.createElement("span",{className:de.text},"development")):null};import P from"react";import*as ve from"@rails/activestorage";import{useState as yt}from"react";import vt,{ErrorCode as ue,useDropzone as zt}from"react-dropzone";var ye="816c6026260587901fa41bc0f1aae9137df94cd44fd26103646eab29e302b1f1",wt=`._dropzoneContainer_14oft_1 {
  display: flex;
  flex-direction: column;
  align-items: center;
  border-width: 2px;
...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(ye)){var e=document.createElement("style");e.id=ye,e.textContent=wt,document.head.appendChild(e)}})();var ce={dropzoneContainer:"_dropzoneContainer_14oft_1",pastezoneContainer:"_pastezoneContainer_14oft_19"};var Ft=(e,t)=>`rails/active_storage/blobs/${e}/${t}`,fe=e=>{let{backendUrl:t,authInfo:r,apiVersion:n}=x(),[i,o]=yt(0),m=P.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:"32",height:"32",fill:"currentColor",className:"bi bi-cloud-arrow-up",viewBox:"0 0 16 16"},P.createElement("path",{fillRule:"evenodd",d:"M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z"}),P.createElement("path",{d:"M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383zm.653.757c-.757.653-1.153 1.44-1.153 2.056v.448l-.445.049C2.064 6.805 1 7.952 1 9.318 1 10.785 2.23 12 3.781 12h8.906C13.98 12 15 10.988 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3a4.53 4.53 0 0 0-2.941 1.1z"})),p=async d=>{await c.delete(t,`active_storage/blobs/${d}`,null,r,n)},a=async(d,u)=>{await p(u);let R=[...e.files];R=R.filter(S=>u!==S.signedId),e.onChange(R),d.stopPropagation()},l=d=>{d.loaded/d.total>=.9999999},f=d=>{if(d.length){if(e.maxFiles){let u=e.maxFiles-(e.files.length+i);if(u<d.length&&e.onMaxFilesError(e.maxFiles),u<=0)return;d=d.slice(0,u)}if(e.maxSize){let u=d.filter(R=>R.size<=e.maxSize);u.length<d.length&&e.onMaxSizeError(e.maxSize),d=u}o(u=>u+d.length),d.forEach(u=>{new ve.DirectUpload(u,s.toApiUrl(t,"active_storage/blobs/create_direct_upload"),{directUploadWillCreateBlobWithXHR:S=>{let N=c.defaultHttpHeader(r,n);Object.keys(N).forEach(h=>{S.setRequestHeader(h,N[h])}),S.upload.addEventListener("progress",l)}}).create((S,N)=>{if(o(h=>h-1),!S){let h={signedId:N.signed_id};u.type.includes("image")?h.path=Ft(N.signed_id,N.filename):h.filename=N.filename;let F=e.files;F.push(h),e.onChange([...F])}})})}},z=d=>{if(!d.clipboardData)return;let u=d.clipboardData.items;if(u===void 0)return;let R=[];for(let S of u){if(e.accept&&!Object.keys(e.accept).some(h=>S.type.match(h)))continue;let N=S.getAsFile();N&&R.push(N)}f(R)},E=e.files.map(d=>P.createElement("div",{key:d.signedId,className:"card w-25 animate__animated animate__fadeIn mb-4",style:{flex:"0 0 auto"}},P.createElement("div",{className:"card-header p-1"},P.createElement("button",{onClick:u=>a(u,d.signedId||""),type:"button",className:"close","aria-label":"Close"},P.createElement("span",{"aria-hidden":"true"},"\xD7"))),P.createElement("div",{className:"d-flex justify-content-center align-items-center w-100 h-100"},P.createElement("img",{src:s.toBaseUrl(t,d.path||""),alt:d.filename,className:"d-block mw-100 m-auto m-0 rounded p-1"})))),g=[];for(let d=0;d<i;d++)g.push(P.createElement("div",{key:d,className:"card w-25 mb-4",style:{flex:"0 0 auto"}},P.createElement("div",{className:"d-flex justify-content-center align-items-center w-100 h-100"},P.createElement("div",{className:"p-4 text-center"},P.createElement("div",{className:"spinner-border",role:"status"},P.createElement("span",{className:"sr-only"},"Loading..."))))));let y=d=>{d.some(u=>u.errors[0].code===ue.TooManyFiles)&&e.onMaxFilesError(e.maxFiles),d.some(u=>u.errors[0].code===ue.FileInvalidType)&&e.onInvalidTypeError(e.accept),d.some(u=>u.errors[0].code===ue.FileTooLarge)&&e.onMaxSizeError(e.maxSize)};return P.createElement("div",null,e.pasteZone&&P.createElement("input",{type:"text",className:`w-100 p-2 ${ce.pastezoneContainer}`,value:e.textPastezone||"Copy and paste some files here",onPaste:z,readOnly:!0}),P.createElement(vt,{onDropAccepted:f,multiple:e.multiple,maxFiles:e.maxFiles,maxSize:e.maxSize,onDropRejected:y,accept:e.accept},({getRootProps:d,getInputProps:u}=zt())=>P.createElement("section",null,P.createElement("div",{...d(),className:`${ce.dropzoneContainer} p-4 ${e.className}`},P.createElement("input",{...u()}),P.createElement("p",{className:"m-0"},e.textDropzone||"Drag 'n' drop some files here, or click to select files"),E.length>0?P.createElement("aside",{className:"card-deck justify-content-center w-100 m-4"},E):P.createElement("div",{className:"m-0"},e.customIcon||m),g.length>0&&P.createElement("aside",{className:"card-deck justify-content-center w-100 m-4"},g)))))};import{Formik as Nt}from"formik";import D from"react-bootstrap/Form";import Ot from"react-bootstrap/Button";import L,{useCallback as kt,useState as It}from"react";import*as Y from"yup";var ze="d79d287dd3a952f0324b32e7f07b6f50490a93b76f363fd81eb38e3ba43c8f1a",Rt=`._container_1c59p_1 {
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: flex-start;
