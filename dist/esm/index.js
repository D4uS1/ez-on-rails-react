import ke,{useMemo as Le,useState as ie}from"react";import{createContext as Se}from"react";var Z=Se({apiVersion:"1.0",backendUrl:"http://localhost:3000",authInfo:null,setBackendUrl:e=>{},setAuthInfo:e=>{},setApiVersion:e=>{}});var Ue=e=>{let[t,r]=ie(e.backendUrl),[n,o]=ie(e.authInfo||null),[i,l]=ie(e.apiVersion),u=Le(()=>{let a={backendUrl:t,authInfo:n||null,apiVersion:i,setBackendUrl:r,setAuthInfo:o,setApiVersion:l};return a.backendUrl.endsWith("/")&&(a.backendUrl=a.backendUrl.slice(0,-1)),a},[t,n,i]);return ke.createElement(Z.Provider,{value:u},e.children)};import h,{useState as tt}from"react";import*as U from"yup";import{Formik as rt}from"formik";import{useCallback as Xe,useEffect as Ze,useState as me}from"react";import{useCallback as We}from"react";import{toCamel as Ae,toSnake as Be}from"convert-keys";var oe=e=>e.startsWith("/")?e.slice(1):e,se=e=>e.endsWith("/")?e.slice(0,-1):e,He=(e,t)=>`${se(e)}/${oe(t)}`,Me=(e,t)=>`${se(e)}/api/${oe(t)}`,Ve=e=>(e=e.replace(/[A-Z]/g,(t,r)=>r===0?t.toLowerCase():"_"+t.toLowerCase()),e=e.replace(/::_/g,"/"),e=e.replace(/\/_/g,"/"),e),Ee=e=>e&&Be(e),he=e=>e&&Ae(e),qe=e=>Object.keys(e).map(t=>t+"="+e[t]).join("&"),J=e=>typeof e=="string"&&/^\d{4}-\d{2}-\d{2}/.test(e)?new Date(e):Array.isArray(e)?e.map(t=>J(t)):(typeof e=="object"&&Object.keys(e).forEach(t=>{e[t]=J(e[t])}),e),K=e=>e instanceof Date?e.toISOString():Array.isArray(e)?e.map(t=>K(t)):(e!==null&&typeof e=="object"&&Object.keys(e).forEach(t=>{e[t]=K(e[t])}),e),De=e=>K(Ee(e)),Ge=e=>!e||typeof e!="object"?e:J(he(e)),s={cleanupUrl:se,cleanupPath:oe,toBaseUrl:He,toApiUrl:Me,toSnakeCase:Ee,toSnakeCasePath:Ve,toCamelCase:he,toGetParameters:qe,toDates:J,toDateStrings:K,toBackendParams:De,toFrontendParams:Ge};var W=class extends Error{httpStatusCode;constructor(t,r){super(),this.message=t,this.httpStatusCode=r}};var $e=e=>{if(e)return{uid:e.uid,client:e.client,expiry:e.expiry,"token-type":e.tokenType,"access-token":e.accessToken}},je=e=>({uid:e.uid,client:e.client,expiry:e.expiry,tokenType:e["token-type"],accessToken:e["access-token"]}),N=(e,t)=>({"Content-Type":"application/json",Accept:"application/json","api-version":t,...$e(e)}),O=async(e,t,r,n)=>{let o=await fetch(t,{method:e,headers:n,body:r?JSON.stringify(r):null});if(o.status>=400)throw new W(JSON.stringify(o.body),o.status);let i={},l=null;try{o.headers.forEach((u,a)=>{i[a]=u}),l=await o.json()}catch{}return{headers:i,body:l}},c={signUp:async(e,t,r)=>{t=s.toBackendParams(t),await O("POST",s.toBaseUrl(e,"users"),{user:t},N(null,r))},signIn:async(e,t,r)=>{t=s.toBackendParams(t);let n=await O("POST",s.toApiUrl(e,"auth/sign_in"),t,N(null,r));return je(n.headers)},signOut:async(e,t,r)=>{await O("DELETE",s.toApiUrl(e,"auth/sign_out"),null,N(t,r))},passwordResetInstructions:async(e,t,r)=>{t=s.toBackendParams(t),await O("POST",s.toBaseUrl(e,"users/password"),{user:t},N(null,r))},passwordReset:async(e,t,r)=>{t=s.toBackendParams(t),await O("PUT",s.toBaseUrl(e,"users/password"),{user:t},N(null,r))},getUser:async(e,t,r)=>{let n=await O("GET",s.toApiUrl(e,"users/me"),null,N(t,r));return s.toFrontendParams(n.body)},updateUser:async(e,t,r,n)=>{let o=t.avatar?.signedId,i={...s.toBackendParams(t),avatar:o},l=await O("PATCH",s.toApiUrl(e,"users/me"),{user:i},N(r,n));return s.toFrontendParams(l.body)},confirmationInstructions:async(e,t,r)=>{t=s.toBackendParams(t),await O("POST",s.toBaseUrl(e,"users/confirmation"),{user:t},N(null,r))},confirmation:async(e,t,r)=>{let n=s.toBaseUrl(e,"users/confirmation");t=s.toBackendParams(t),n=`${n}?${s.toGetParameters(t)}`,await O("GET",n,null,N(null,r))},get:async(e,t,r,n=null,o="1.0",i=void 0)=>{let l=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r)),r&&(l=`${l}?${s.toGetParameters(r)}`);let u=await O("GET",l,null,N(n,o));return s.toFrontendParams(u.body)},post:async(e,t,r,n=null,o="1.0",i=void 0)=>{let l=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r));let u=await O("POST",l,r,N(n,o));return s.toFrontendParams(u.body)},patch:async(e,t,r,n=null,o="1.0",i=void 0)=>{let l=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r));let u=await O("PATCH",l,r,N(n,o));return s.toFrontendParams(u.body)},put:async(e,t,r,n=null,o="1.0",i=void 0)=>{let l=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r));let u=await O("PUT",l,r,N(n,o));return s.toFrontendParams(u.body)},delete:async(e,t,r,n=null,o="1.0",i=void 0)=>{let l=s.toApiUrl(e,t);r&&(r=s.toBackendParams(r)),i&&(r=i(r)),r&&(l=`${l}?${s.toGetParameters(r)}`);let u=await O("DELETE",l,null,N(n,o));return s.toFrontendParams(u.body)},defaultHttpHeader:(e,t)=>N(e,t)};import{useContext as Ye}from"react";var P=()=>Ye(Z);var le=e=>{let{backendUrl:t,authInfo:r,apiVersion:n}=P();return{call:We(async(i,l,u)=>{let a=e?s.cleanupPath(s.cleanupUrl(e)):null,m=s.cleanupPath(i),p=`${a?a+"/":""}${m}`;switch(l){case"POST":return c.post(t,p,u,r,n);case"PUT":return c.put(t,p,u,r,n);case"PATCH":return c.patch(t,p,u,r,n);case"DELETE":return c.delete(t,p,u,r,n);default:return c.get(t,p,u,r,n)}},[])}};var Je=(e,t="GET",r,n)=>{let{backendUrl:o,authInfo:i,apiVersion:l}=P(),[u,a]=me(null),[m,p]=me(null),[B,T]=me(!1),{call:g}=le(),y=Xe(async d=>{try{T(!0),p(null),a(null);let f=await g(e,t,d||r);return a(f),T(!1),f}catch(f){p(f),T(!1)}},[]);return Ze(()=>{(async()=>n?.skipInitialCall||await y())()},[i,o,l]),{data:u,error:m,inProgress:B,callApi:y}};import{useCallback as G,useMemo as Ke,useState as Q}from"react";var Qe=e=>{let{backendUrl:t,authInfo:r,apiVersion:n}=P(),[o,i]=Q(null),[l,u]=Q(null),[a,m]=Q(!1),[p,B]=Q(null),T=Ke(()=>s.toSnakeCasePath(e),[e]),g=G(async E=>{B(null),m(!0);try{let F=await E();return m(!1),F}catch(F){return m(!1),B(F),null}},[]),y=G(()=>g(async()=>{let E=await c.get(t,T,null,r,n);return u(E),E}),[t,r,n,T]),d=G(E=>g(async()=>{let F=await c.get(t,`${T}/${E}`,null,r,n);return i(F),F}),[t,r,n,T]),f=G(E=>g(async()=>{let F=await c.get(t,T,E,r,n);return u(F),F}),[t,r,n,T]),z=G(E=>g(async()=>{let F=await c.post(t,T,E,r,n);return i(F),F}),[t,r,n,T]),S=G((E,F)=>g(async()=>{let be=await c.patch(t,`${T}/${E}`,F,r,n);return i(be),be}),[t,r,n,T]),R=G(E=>g(async()=>{await c.delete(t,`${T}/${E}`,null,r,n),i(null)}),[t,r,n,T]);return{record:o,records:l,inProgress:a,error:p,getAll:y,getOne:d,search:f,create:z,update:S,remove:R}};import{Button as nt,Form as v}from"react-bootstrap";var Ce="98b7b7c91ad248732620fd26b7470028caf4d1487f4e49ae229f3ce1f7f773d3",et=`._container_1c59p_1 {
    display: flex;
...
`;(function(){if(!(typeof document>"u")&&!document.getElementById(_e)){var e=document.createElement("style");e.id=_e,e.textContent=Pt,document.head.appendChild(e)}})();var de={container:"_container_q2u8x_1",text:"_text_q2u8x_13"};var Tt=e=>{let[t,r]=xt(e.visible),n=()=>{r(!0)};return t?we.createElement("div",{onClick:()=>{r(!1),setTimeout(n,e.dismissTimeout||2e4)},className:de.container},we.createElement("span",{className:de.text},"development")):null};import C from"react";import*as ve from"@rails/activestorage";import{useState as wt}from"react";import yt,{ErrorCode as ue,useDropzone as vt}from"react-dropzone";var ye="f3fc0c9d5e5746fd5691edad8df784d8ef85c8071507491c8817f5f196e4d1cd",_t=`._dropzoneContainer_14oft_1 {
  display: flex;
  flex-direction: column;
  align-items: center;
  border-width: 2px;
